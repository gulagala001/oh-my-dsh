...
export interface ChildStartRequest {
  /** Invocation order, assigned before acquiring a concurrency slot. */
  seq: number
...
export interface ChildResult {
  ...
  childId?: string
  worktree?: import('./worktree.ts').WorktreeArtifact
}
...
export interface ChildPort {
  ...
  loadWorkflow?(reference: string | { scriptPath: string }): Promise<{ meta: WorkflowMeta; body: string }>
}
