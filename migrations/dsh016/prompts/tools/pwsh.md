...
- Read the managed `$env:DSH_*` values when you need the current harness environment. Long output is truncated; use the returned file path for the full output when one is provided.
