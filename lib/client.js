...
var CONTEXT_FREQUENCY_PRESETS = Object.freeze({
  always: Object.freeze({ digestEvery: 32, digestWindow: 32, coordinatorEvery: 2, coordinatorMinGapMs: 3e4, surgeryCooldownSteps: 20 }),
  medium: Object.freeze({ digestEvery: 48, digestWindow: 48, coordinatorEvery: 3, coordinatorMinGapMs: 6e4, surgeryCooldownSteps: 30 }),
  slow: Object.freeze({ digestEvery: 64, digestWindow: 64, coordinatorEvery: 4, coordinatorMinGapMs: 12e4, surgeryCooldownSteps: 40 })
});
...
function createContextUI(React21) {
  ...
  class ContextSettings2 extends React21.Component {
    ...
    frequency() {
      ...
      return section("\u5904\u7406\u9891\u7387", "\u9ED8\u8BA4\u4F7F\u7528\u9002\u4E2D\u6863\uFF0C\u53EF\u6309\u5DE5\u4F5C\u8282\u594F\u8C03\u6574\u3002", h(
        React21.Fragment,
        null,
