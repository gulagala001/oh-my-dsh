...
function createContextUI(React20) {
  const h = React20.createElement;
  ...
  const field = (label, input, hint) => h("label", { className: "cx-field" }, h("span", null, label), React20.cloneElement(input, { "aria-label": input.props["aria-label"] || label }), hint && h("small", null, hint));
  ...
  const summaryPreview = (text) => h(React20.Fragment, null, h("p", { className: "cx-prose" }, text.length > 240 ? text.slice(0, 240) + "\u2026" : text), text.length > 240 && fold("\u5C55\u5F00\u5B8C\u6574\u6458\u8981", text.length + " \u5B57\u7B26", h("p", { className: "cx-prose" }, text)));
  ...
  class DocumentReader extends React20.Component {
    componentDidMount() {
  ...
  class PollPanel extends React20.Component {
    constructor(props) {
      super(props);
  ...
  class ContextSettings2 extends React20.Component {
    ...
    renderModels() {
      ...
      return h(
        ...
        section("\u540E\u53F0\u6A21\u578B", "\u4E3B\u6267\u884C\u6A21\u578B\u4ECD\u5728 DSH \u7684\u6A21\u578B\u8BBE\u7F6E\u4E2D\u9009\u62E9\u3002", h(
          ...
          mode === "follow" ? h("div", { className: "cx-info" }, icon("layers"), h("p", null, "\u9884\u5904\u7406 AI \u548C\u4E2D\u67A2\u4F7F\u7528\u5F53\u524D\u4F1A\u8BDD\u7684\u63D0\u4F9B\u65B9\u4E0E\u6A21\u578B\u3002")) : mode === "unified" ? this.route("unifiedBackground", "\u9884\u5904\u7406\u4E0E\u4E2D\u67A2") : h(React20.Fragment, null, this.route("background", "\u9884\u5904\u7406 AI"), this.route("surgeon", "\u4E2D\u67A2 AI"))
        )),
  ...
  class ScopeControl extends React20.Component {
...
// src/client/index.jsx
var { ContextSettings, ScopeChip, wrapWorkbench, applyStyle } = createContextUI(import_react19.default);
...
function apply(ctx) {
  ...
  function Workbench({ initialSection = "tasks", ...props }) {
    ...
    return /* @__PURE__ */ import_react19.default.createElement(Component, { ...props });
  }
