...
function createContextUI(React20) {
  ...
  const names2 = { raw: "\u539F\u6587", keep: "\u4FDD\u7559\u539F\u6587", detail: "\u6458\u8981\uFF0B\u6587\u6863", brief: "\u4EC5\u57FA\u7840\u6458\u8981", merge: "\u5408\u5E76\u66FF\u6362", session: "\u4F1A\u8BDD\u9694\u79BB", project: "\u9879\u76EE\u5171\u4EAB" };
    ...
    render() {
      ...
      return h(
        ...
        { className: "cx-reader", ref: (el) => {
          this.root = el;
        }, tabIndex: -1, role: "dialog", "aria-modal": true, "aria-label": "\u8BE6\u7EC6\u6587\u6863", onKeyDown: (e) => {
  ...
  class PollPanel extends React20.Component {
    ...
    componentDidUpdate(prev) {
      if (prev.sessionId !== this.props.sessionId) {
        ...
        this.documentTicket++;
        this.reviewTicket++;
        this.setState({ data: null, detail: null, selected: [], review: null, legacy: null, error: "", notice: "", busy: false });
        clearTimeout(this.timer);
        this.tick();
    ...
    run = async (path, body, success) => {
      ...
      try {
        ...
        if (this.alive && this.props.sessionId === id) {
          this.setState({ notice: success ? success(result) : result.queued ? "\u5DF2\u52A0\u5165\u540E\u53F0\u961F\u5217\u3002" : "\u5DF2\u4FDD\u5B58", ...path === "/compact" ? { selected: [] } : {} });
          await this.load();
        }
      } catch (e) {
        if (this.alive && this.props.sessionId === id) this.setState({ error: e.message });
      } finally {
        if (this.alive && this.props.sessionId === id) this.setState({ busy: false });
      }
    };
    document = async (id) => {
        ...
        h(
          ...
          !this.props.sessionId ? empty("\u5148\u9009\u62E9\u4E00\u4E2A\u4F1A\u8BDD", "\u8FD9\u91CC\u4F1A\u663E\u793A\u672C\u4F1A\u8BDD\u7684\u5206\u6BB5\u6458\u8981\u4E0E\u66FF\u6362\u72B6\u6001\u3002") : !d ? empty("\u6B63\u5728\u8BFB\u53D6\u4E0A\u4E0B\u6587", "\u6B63\u5728\u8FDE\u63A5\u5F53\u524D\u4F1A\u8BDD\u7684\u9884\u5904\u7406\u8BB0\u5F55\u3002") : h(
            ...
            h(
              ...
              h("div", { className: "cx-metrics" }, h("div", null, h("strong", null, fmt2(records.length)), h("span", null, "\u5206\u6BB5\u6458\u8981")), h("div", null, h("strong", null, fmt2(ready)), h("span", null, "\u539F\u6587\u5F85\u66FF\u6362")), h("div", null, h("strong", null, fmt2(records.reduce((n, r) => n + (r.documentCount || 0), 0))), h("span", null, "\u8BE6\u7EC6\u6587\u6863"))),
            ...
            !shown.length ? empty(records.length ? "\u5F53\u524D\u7B5B\u9009\u6CA1\u6709\u5185\u5BB9" : "\u8FD8\u6CA1\u6709\u5206\u6BB5\u6458\u8981", records.length ? "\u5207\u6362\u201C\u5168\u90E8\u201D\u67E5\u770B\u5176\u4ED6\u8BB0\u5F55\u3002" : "\u8FBE\u5230\u9884\u5904\u7406\u9891\u7387\u540E\uFF0C\u8FD9\u91CC\u4F1A\u81EA\u52A8\u51FA\u73B0\u57FA\u7840\u6458\u8981\u548C\u6587\u6863\u3002") : h("div", { className: "cx-list" }, ...shown.map((r, i) => h(
              ...
              h("div", { className: "cx-row" }, h("label", { className: "cx-record-check" }, h("input", { type: "checkbox", checked: selected.includes(r.id), disabled: !r.live || busy, onChange: (e) => this.select(r.id, e.target.checked), "aria-label": "\u9009\u62E9 " + r.id }), h("span", { className: "cx-record-number" }, String(i + 1).padStart(2, "0")), h("time", null, date(r.timeStart) + " \u2014 " + time(r.timeEnd))), badge(r.live ? names2[r.mode] || r.mode : "\u5386\u53F2\u5B58\u6863", r.mode === "raw" ? "" : "blue")),
              h("p", { className: "cx-prose" }, r.summary),
              h("div", { className: "cx-record-footer" }, h("small", { title: r.id }, h("code", null, r.id.slice(0, 8)), " \xB7 ", rangeLabel(r.ranges)), button(`${r.documentCount || 0} \u4EFD\u6587\u6863`, () => this.document(r.id), { icon: "context", quiet: true }))
            ))),
  ...
  class ContextSettings2 extends React20.Component {
    ...
    number(key, label, min = 0, hint, scale = 1) {
      const value = this.state.config[key];
      return field(label, h("input", { type: "number", required: true, min, step: 1 / scale, value: value === "" ? "" : (value ?? 0) / scale, onChange: (e) => this.set(key, e.target.value === "" ? "" : Number(e.target.value) * scale) }), hint);
    }
    ...
    renderAdvanced() {
      ...
      return h(
        ...
        fold("\u9884\u5904\u7406\u7A97\u53E3", "\u5206\u6BB5\u3001\u53C2\u8003\u524D\u6587\u4E0E\u7A7A\u95F2\u51B2\u5237", h("div", { className: "cx-grid" }, this.number("digestEvery", "\u9884\u5904\u7406\u9891\u7387 \xB7 \u65B0\u4E8B\u4EF6\u6570", 1), this.number("digestWindow", "\u76EE\u6807\u5206\u6BB5\u7A97\u53E3 \xB7 \u4E8B\u4EF6\u6570", 1, "\u4FDD\u7559\u5B8C\u6574\u5DE5\u5177\u5F80\u8FD4\uFF0C\u5B9E\u9645\u6BB5\u957F\u53EF\u80FD\u8D85\u8FC7\u7A97\u53E3\u3002"), this.number("digestLookback", "\u53C2\u8003\u524D\u6587 \xB7 \u4E8B\u4EF6\u6570", 0), this.number("flushIdleMs", "\u65E0\u65B0\u4E8B\u4EF6\u51B2\u5237 \xB7 \u79D2", 0, "0 \u5173\u95ED\uFF1B\u5DE5\u5177\u957F\u65F6\u95F4\u8FD0\u884C\u4E5F\u53EF\u80FD\u89E6\u53D1\u3002", 1e3))),
...
var kindName = { prepare: "\u4E0A\u4E0B\u6587\u9884\u5904\u7406", coordinate: "\u66FF\u6362\u4E2D\u67A2", main: "\u4E3B\u6267\u884C", subagent: "\u5B50\u4EE3\u7406", background: "\u8BB0\u5FC6\u6D88\u5316", recall: "\u8BB0\u5FC6\u68C0\u7D22", state: "\u72B6\u6001\u63D0\u70BC", curation: "\u8BB0\u5FC6\u6574\u7406", surgeon: "\u4E0A\u4E0B\u6587\u6574\u7406", probeAsk: "\u63A2\u9488\u51FA\u9898", probeAnswer: "\u63A2\u9488\u4F5C\u7B54" };
