...
function DeviceFrame({ enabled, interactive, width, height, scale, onResize, onError, children }) {
  ...
  const apply2 = async (size) => {
    ...
    const version2 = revision.current;
    setPending(true);
    try {
      await onResize(size);
    } catch (error) {
      if (version2 === revision.current) onError?.(error.message);
    } finally {
      if (version2 === revision.current) setPending(false);
    }
  };
...
var BrowserTools = (0, import_react7.forwardRef)(function BrowserTools2({ sessionId, target, frame, state, api: api3, onState, onError, previewScale = "1", onPreviewScale, onDeviceModeChange, popupOpen, onMenuOpen, onOpenHistory, onOpenDownloads }, ref) {
  ...
  const action = async (op, value = {}) => {
    ...
    const current = latest.current, observed = current.frame, version2 = generation.current;
    ...
    try {
      ...
      if (version2 !== generation.current || latest.current.target?.id !== observed.tabId) return false;
      ...
      if (!controller.signal.aborted && version2 === generation.current) latest.current.onError(error.message);
      return false;
    } finally {
      if (request.current === controller) request.current = null;
      if (version2 === generation.current) setBusy(false);
    }
  };
...
// src/client/version-info.jsx
var import_react19 = __toESM(require("react"), 1);
var import_react_dom3 = require("react-dom");

// package.json
var version = "1.3.0-alpha.8";

// src/client/version-info.jsx
var statusText = (data) => data.status === "update" ? data.severity === "required" ? "\u6709\u5FC5\u8981\u66F4\u65B0 \xB7 \u5305\u542B\u91CD\u8981\u4FEE\u590D" : "\u6709\u65B0\u7248\u672C\u53EF\u66F4\u65B0" : data.status === "current" ? "\u5DF2\u662F\u6700\u65B0\u7248" : data.status === "ahead" ? "\u5F53\u524D\u7248\u672C\u9AD8\u4E8E\u53D1\u5E03\u8BB0\u5F55" : "\u5C1A\u672A\u786E\u8BA4\u6700\u65B0\u7248\u672C";
var timeText = (time) => time == null ? "\u5C1A\u672A\u6210\u529F\u68C0\u67E5" : new Date(time).toLocaleString("zh-CN", { hour12: false });
function VersionInfo() {
  const [data, setData] = (0, import_react19.useState)({ currentVersion: version, status: "unknown", severity: "none", releases: [] });
  const [open, setOpen] = (0, import_react19.useState)(false), [busy, setBusy] = (0, import_react19.useState)(false);
  const button = (0, import_react19.useRef)(null), dialog = (0, import_react19.useRef)(null), active = (0, import_react19.useRef)(false), pending = (0, import_react19.useRef)(null), abort = (0, import_react19.useRef)(null), titleId = (0, import_react19.useId)();
  const load = (0, import_react19.useCallback)((refresh = false) => {
  ...
  (0, import_react19.useEffect)(() => {
    ...
    const tick = async () => {
      ...
      if (active.current) timer = setTimeout(tick, 60 * 60 * 1e3);
    };
    const visible = () => {
  ...
  (0, import_react19.useEffect)(() => {
    ...
    const place = () => {
      ...
      element.style.maxHeight = Math.max(120, window.innerHeight - top - 12) + "px";
    };
    place();
  ...
  return /* @__PURE__ */ import_react19.default.createElement("span", { className: "omd-version", onClick: (event) => event.stopPropagation(), onKeyDown: (event) => event.stopPropagation() }, /* @__PURE__ */ import_react19.default.createElement(
    "button",
    {
      ref: button,
      type: "button",
      ...
      title: "Oh My DSH " + data.currentVersion + " \xB7 " + statusText(data),
      onClick: () => {
        setOpen(true);
        void load();
      }
    },
    /* @__PURE__ */ import_react19.default.createElement("svg", { viewBox: "0 0 20 20", width: "17", height: "17", fill: "none", stroke: "currentColor", strokeWidth: "1.45", "aria-hidden": "true" }, /* @__PURE__ */ import_react19.default.createElement("circle", { cx: "10", cy: "10", r: "7.4" }), /* @__PURE__ */ import_react19.default.createElement("path", { d: "M10 8.7v5" }), /* @__PURE__ */ import_react19.default.createElement("circle", { cx: "10", cy: "6.1", r: ".85", fill: "currentColor", stroke: "none" })),
    severity !== "none" && /* @__PURE__ */ import_react19.default.createElement("span", { className: "omd-update-dot omd-update-" + severity, "aria-hidden": "true" })
  ), /* @__PURE__ */ import_react19.default.createElement("span", { id: titleId + "-hint", className: "omd-version-sr" }, statusText(data), data.stale ? "\uFF0C\u4E0A\u6B21\u68C0\u67E5\u7ED3\u679C" : ""), /* @__PURE__ */ import_react19.default.createElement(
    "dialog",
    {
      ref: dialog,
    ...
    open && /* @__PURE__ */ import_react19.default.createElement(import_react19.default.Fragment, null, /* @__PURE__ */ import_react19.default.createElement("header", null, /* @__PURE__ */ import_react19.default.createElement("h2", { id: titleId }, "\u5173\u4E8E Oh My DSH"), /* @__PURE__ */ import_react19.default.createElement("button", { type: "button", className: "omd-version-close", "aria-label": "\u5173\u95ED\u7248\u672C\u4FE1\u606F", onClick: () => setOpen(false) }, "\xD7")), /* @__PURE__ */ import_react19.default.createElement("dl", null, /* @__PURE__ */ import_react19.default.createElement("div", null, /* @__PURE__ */ import_react19.default.createElement("dt", null, "\u5F53\u524D\u7248\u672C"), /* @__PURE__ */ import_react19.default.createElement("dd", { "data-testid": "omd-current-version" }, data.currentVersion)), /* @__PURE__ */ import_react19.default.createElement("div", null, /* @__PURE__ */ import_react19.default.createElement("dt", null, "\u6700\u65B0\u7248\u672C"), /* @__PURE__ */ import_react19.default.createElement("dd", null, data.latestVersion || "\u5C1A\u672A\u786E\u8BA4"))), /* @__PURE__ */ import_react19.default.createElement("p", { className: "omd-version-status omd-level-" + severity, role: "status" }, statusText(data), data.stale ? "\uFF08\u4E0A\u6B21\u68C0\u67E5\u7ED3\u679C\uFF09" : ""), data.error && /* @__PURE__ */ import_react19.default.createElement("p", { className: "omd-version-error", role: "alert" }, data.error), /* @__PURE__ */ import_react19.default.createElement("div", { className: "omd-version-releases" }, (updates.length ? updates : data.currentRelease ? [data.currentRelease] : []).map((release) => /* @__PURE__ */ import_react19.default.createElement("section", { key: release.version }, /* @__PURE__ */ import_react19.default.createElement("h3", null, /* @__PURE__ */ import_react19.default.createElement("span", null, release.version), updates.length > 0 && /* @__PURE__ */ import_react19.default.createElement("em", { "data-severity": release.severity }, release.severity === "required" ? "\u5FC5\u8981\u66F4\u65B0" : "\u666E\u901A\u66F4\u65B0")), /* @__PURE__ */ import_react19.default.createElement("strong", null, release.title), /* @__PURE__ */ import_react19.default.createElement("ul", null, release.notes?.map((note, i) => /* @__PURE__ */ import_react19.default.createElement("li", { key: i }, note)))))), /* @__PURE__ */ import_react19.default.createElement("p", { className: "omd-version-meta" }, "\u4E0A\u6B21\u6210\u529F\u68C0\u67E5\uFF1A", timeText(data.checkedAt)), /* @__PURE__ */ import_react19.default.createElement("p", { className: "omd-version-meta" }, "\u4EC5\u8BFB\u53D6\u5B98\u65B9\u4ED3\u5E93\u7684\u516C\u5F00\u53D1\u5E03\u4FE1\u606F\uFF0C\u4E0D\u81EA\u52A8\u5B89\u88C5\uFF0C\u4E0D\u4E0A\u4F20\u4F1A\u8BDD\u5185\u5BB9\u3002"), data.currentVersion !== version && /* @__PURE__ */ import_react19.default.createElement("p", { className: "omd-version-error" }, "\u670D\u52A1\u5DF2\u66F4\u65B0\uFF0C\u5F53\u524D\u754C\u9762\u4ECD\u4E3A ", version, "\u3002", /* @__PURE__ */ import_react19.default.createElement("button", { type: "button", onClick: () => window.location.reload() }, "\u5237\u65B0\u754C\u9762")), /* @__PURE__ */ import_react19.default.createElement("footer", null, /* @__PURE__ */ import_react19.default.createElement("button", { type: "button", className: "omd-version-check", disabled: busy, onClick: () => void load(true) }, busy ? "\u6B63\u5728\u68C0\u67E5\u2026" : "\u68C0\u67E5\u66F4\u65B0"), /* @__PURE__ */ import_react19.default.createElement("a", { href: "https://github.com/gulagala001/oh-my-dsh/blob/main/CHANGELOG.md", target: "_blank", rel: "noopener noreferrer" }, "\u67E5\u770B\u53D1\u5E03\u8BB0\u5F55 \u2197")))
  ));
}
function BrandNameWithVersion() {
  const name = (0, import_react19.useRef)(null), [mount, setMount] = (0, import_react19.useState)(null);
  (0, import_react19.useLayoutEffect)(() => {
    const brand = name.current?.closest("button");
...
function createContextUI(React21) {
  const h = React21.createElement;
  const api3 = async (path, body) => {
    const response = await fetch("/trisoul-x/api" + path, body === void 0 ? {} : { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) });
    const data = await response.json();
    if (!response.ok) throw Error(data.error || "HTTP " + response.status);
    return data;
  };
  const suffix2 = (id) => "?session=" + encodeURIComponent(id || "");
  const fmt2 = (value) => Number(value || 0).toLocaleString();
  ...
  const names2 = { raw: "\u539F\u6587", keep: "\u4FDD\u7559\u539F\u6587", detail: "\u6458\u8981\uFF0B\u8BE6\u7EC6\u8D44\u6599", brief: "\u4EC5\u57FA\u7840\u6458\u8981", merge: "\u5408\u5E76\u66FF\u6362", session: "\u4F1A\u8BDD\u9694\u79BB", project: "\u9879\u76EE\u5171\u4EAB" };
  ...
  const button = (text, onClick, options = {}) => h("button", { type: "button", onClick, disabled: options.disabled, className: "cx-btn " + (options.primary ? "cx-primary " : "") + (options.quiet ? "cx-quiet " : "") + (options.className || ""), title: options.title, "aria-label": options.label || (typeof text === "string" ? text : void 0) }, options.icon && icon(options.icon), text);
  ...
  const field = (label, input, hint) => h("label", { className: "cx-field" }, h("span", null, label), React21.cloneElement(input, { "aria-label": input.props["aria-label"] || label }), hint && h("small", null, hint));
  ...
  const fold = (text, sub, children, open = false) => h("details", { className: "cx-fold", open: open || void 0 }, h("summary", null, h("span", null, h("strong", null, text), sub && h("small", null, sub)), icon("chevron", 14)), h("div", { className: "cx-fold-body" }, children));
  ...
  const segments2 = (label, value, options, change) => h("div", { className: "cx-segments", role: "group", "aria-label": label }, ...options.map(([id, text]) => h("button", { key: id, type: "button", "aria-pressed": id === value, onClick: () => change(id) }, text)));
  const pageTabs = (value, options, change) => h("nav", { className: "cx-tabs", "aria-label": "\u8BBE\u7F6E\u5206\u7C7B" }, ...options.map(([id, text]) => h("button", { key: id, type: "button", "aria-current": id === value ? "page" : void 0, onClick: () => change(id) }, text)));
  const duration2 = (ms) => Number(ms) >= 6e4 ? Number(ms) / 6e4 + " \u5206\u949F" : Number(ms || 0) / 1e3 + " \u79D2";
  const rangeLabel = (ranges) => (ranges || []).map((x) => `#${x.from}\u2013${x.to}`).join(" \xB7 ");
  const summaryPreview = (text) => h(React21.Fragment, null, h("p", { className: "cx-prose" }, text.length > 240 ? text.slice(0, 240) + "\u2026" : text), text.length > 240 && fold("\u5C55\u5F00\u5B8C\u6574\u6458\u8981", text.length + " \u5B57\u7B26", h("p", { className: "cx-prose" }, text)));
  const assetUrl = (r, i) => "/trisoul-x/api/context/asset" + suffix2(r.requestSessionId || r.sessionId) + "&id=" + encodeURIComponent(r.id) + "&asset=" + (i + 1);
  class DocumentReader extends React21.Component {
    componentDidMount() {
    ...
    render() {
      ...
      return h(
        "section",
        { className: "cx-reader", ref: (el) => {
          this.root = el;
        }, tabIndex: -1, role: "dialog", "aria-modal": true, "aria-label": "\u8BE6\u7EC6\u8D44\u6599", onKeyDown: (e) => {
          ...
          if (e.key === "Tab") {
            ...
            if (e.shiftKey && (document.activeElement === first || document.activeElement === this.root)) {
              e.preventDefault();
              last?.focus();
            } else if (!e.shiftKey && (document.activeElement === last || document.activeElement === this.root)) {
              e.preventDefault();
              first?.focus();
            }
          }
        ...
        h(
          ...
          h("div", { className: "cx-record-meta" }, h("code", null, r.id), h("small", null, date(r.timeStart) + " \u2014 " + time(r.timeEnd))),
          ...
          ...(r.assets || []).map((asset, i) => fold((asset.block.attachment?.name || asset.block.type) + " \xB7 \u9644\u4EF6 " + (i + 1), (asset.sources || []).map((x) => x.sessionId + "#" + x.seq).join("\u3001"), h("div", null, asset.block.type === "image" && h("img", { src: assetUrl(r, i), alt: "\u539F\u59CB\u56FE\u7247 " + (i + 1), loading: "lazy", style: { maxWidth: "100%", height: "auto" } }), h("a", { href: assetUrl(r, i), target: "_blank", rel: "noopener noreferrer" }, "\u6253\u5F00\u539F\u4EF6")))),
  ...
  class PollPanel extends React21.Component {
    constructor(props) {
      super(props);
      this.state = { data: null, error: "", notice: "", busy: false, detail: null };
      this.epoch = 0;
      this.cycle = 0;
    ...
    componentDidUpdate(prev) {
      if (prev.sessionId !== this.props.sessionId) {
        ...
        clearTimeout(this.timer);
        this.tick();
      } else if (!prev.visible && this.props.visible) {
        this.cycle++;
        clearTimeout(this.timer);
        this.tick();
      }
    ...
    tick = async () => {
      ...
      if (this.props.visible !== false && this.props.sessionId) await this.load();
      if (this.alive && cycle === this.cycle) this.timer = setTimeout(this.tick, 2500);
    };
    load = async () => {
      const token = ++this.epoch;
      try {
        const data = await api3(this.path() + suffix2(this.props.sessionId));
        ...
        if (this.alive && token === this.epoch) this.setState({ error: e.message });
      }
    };
    run = async (path, body, success) => {
      if (this.state.busy) return;
      this.setState({ busy: true, activeAction: path, error: "", notice: "" });
      const id = this.props.sessionId;
      try {
        const result = await api3(path + suffix2(id), body);
        if (this.alive && this.props.sessionId === id) {
          this.setState({ notice: success ? success(result) : result.queued ? "\u5DF2\u52A0\u5165\u540E\u53F0\u961F\u5217\u3002" : "\u5DF2\u4FDD\u5B58", ...["/compact", "/compact-p", "/compact-f"].includes(path) ? { selected: [] } : {} });
          await this.load();
        }
      } catch (e) {
        if (this.alive && this.props.sessionId === id) this.setState({ error: e.message });
      } finally {
        if (this.alive && this.props.sessionId === id) this.setState({ busy: false, activeAction: null });
      }
    };
    document = async (id) => {
      const sid = this.props.sessionId, ticket = ++this.documentTicket;
      try {
        const detail = await api3("/context/document" + suffix2(sid) + "&id=" + encodeURIComponent(id));
        if (this.alive && this.props.sessionId === sid && ticket === this.documentTicket) this.setState({ detail });
      } catch (e) {
        if (this.alive && this.props.sessionId === sid && ticket === this.documentTicket) this.setState({ error: e.message });
      }
    };
    readReview = async () => {
      const sid = this.props.sessionId, ticket = ++this.reviewTicket;
      try {
        const review = await api3("/context/review" + suffix2(sid));
        if (this.alive && sid === this.props.sessionId && ticket === this.reviewTicket) this.setState({ review });
      } catch (e) {
        if (this.alive && sid === this.props.sessionId) this.setState({ error: e.message });
      }
    };
    reader() {
      return this.state.detail && h(DocumentReader, { record: this.state.detail, onClose: () => {
        this.documentTicket++;
  ...
  class PipelinePanel extends PollPanel {
    ...
    select(id, checked) {
      this.setState((s) => ({ selected: checked ? [.../* @__PURE__ */ new Set([...s.selected, id])] : s.selected.filter((x) => x !== id) }));
    }
    render() {
      ...
      return h(
        ...
        heading("\u5DE5\u4F5C\u4E0A\u4E0B\u6587", "\u9884\u5904\u7406\u5728\u540E\u53F0\uFF0C\u66FF\u6362\u5728\u8BF7\u6C42\u8FB9\u754C\u3002", "context", button(null, this.load, { icon: "refresh", quiet: true, label: "\u5237\u65B0\u4E0A\u4E0B\u6587" })),
        h(
          "div",
          { className: "cx-body" },
          alert(error, true),
          alert(notice),
          !this.props.sessionId ? empty("\u5148\u9009\u62E9\u4E00\u4E2A\u4F1A\u8BDD", "\u8FD9\u91CC\u4F1A\u663E\u793A\u672C\u4F1A\u8BDD\u7684\u5206\u6BB5\u6458\u8981\u4E0E\u66FF\u6362\u72B6\u6001\u3002") : !d ? empty("\u6B63\u5728\u8BFB\u53D6\u4E0A\u4E0B\u6587", "\u6B63\u5728\u8FDE\u63A5\u5F53\u524D\u4F1A\u8BDD\u7684\u9884\u5904\u7406\u8BB0\u5F55\u3002") : h(
            React21.Fragment,
            null,
            h(
              "section",
              { className: "cx-pipeline-card" },
              h("div", { className: "cx-row" }, h("span", { className: "cx-eyebrow" }, "\u5904\u7406\u72B6\u6001"), badge(names2[d.scope?.scope] || "\u4F1A\u8BDD", d.scope?.scope === "session" ? "" : "blue")),
              ...
              h("div", { className: "cx-metrics" }, h("div", null, h("strong", null, fmt2(records.length)), h("span", null, "\u5206\u6BB5\u6458\u8981")), h("div", null, h("strong", null, fmt2(ready)), h("span", null, "\u539F\u6587\u5F85\u66FF\u6362")), h("div", null, h("strong", null, fmt2(records.reduce((n, r) => n + (r.documentCount || 0) + (r.assetCount || 0), 0))), h("span", null, "\u8BE6\u7EC6\u8D44\u6599\u5B58\u6863"))),
            ...
            d.prepareDeferred && h("p", { className: "cx-hint" }, "\u672C\u6279\u5DF2\u7ED3\u675F\uFF1A\u5269\u4F59 " + fmt2(d.prepareDeferred.events) + " \u6761\u3001\u7EA6 " + fmt2(d.prepareDeferred.estimatedTokens) + " tokens\uFF0C\u7559\u5F85\u4E0B\u6B21\u89E6\u53D1\u3002"),
            section("\u672A\u5904\u7406\u539F\u6587", "\u4E0E\u5DF2\u51C6\u5907\u3001\u5F85\u66FF\u6362\u7684\u6458\u8981\u5206\u5F00\u7EDF\u8BA1\u3002", h("p", { className: "cx-prose" }, "\u5F85\u9884\u5904\u7406 " + fmt2(d.backlog?.events) + " \u6761 \xB7 \u4F30\u7B97 " + fmt2(d.backlog?.estimatedTokens) + " tokens\uFF1B\u8FD1\u671F\u6682\u7559 " + fmt2(d.backlog?.recentEvents) + " \u6761\u3002")),
            d.lastReplacement?.stats && section("\u6700\u8FD1\u4E00\u6B21\u66FF\u6362", "\u4EE5\u4E0B\u4E3A\u540C\u53E3\u5F84\u4F30\u7B97\uFF0C\u4E0D\u662F\u63D0\u4F9B\u65B9\u5B9E\u9645\u8F93\u5165\u8D26\u5355\u3002", h("p", { className: "cx-prose" }, "\u5904\u7406 " + fmt2(d.lastReplacement.stats.selectedRecords) + " \u6BB5 \u2192 " + fmt2(d.lastReplacement.stats.resultRecords) + " \u6BB5\uFF1B\u66FF\u6362 " + fmt2(d.lastReplacement.stats.currentMessages) + " \u6761\u5F53\u524D\u6D88\u606F\uFF0C\u8986\u76D6 " + fmt2(d.lastReplacement.stats.originalEvents) + " \u6761\u539F\u59CB\u4E8B\u4EF6\uFF1B\u4F30\u7B97\u8282\u7701 " + fmt2(d.lastReplacement.stats.estimatedSavedTokens) + " tokens\u3002")),
            section("\u624B\u52A8\u538B\u7F29", "\u538B\u7F29\u53EA\u6539\u53D8\u5F53\u524D\u4E0A\u4E0B\u6587\uFF0C\u539F\u59CB\u65E5\u5FD7\u548C\u8BE6\u7EC6\u8D44\u6599\u5B58\u6863\u4FDD\u7559\u3002", h(
              React21.Fragment,
              null,
            ...
            h("div", { className: "cx-list-head" }, h("h3", null, "\u5206\u6BB5\u6458\u8981"), segments2("\u7B5B\u9009\u5206\u6BB5", filter, [["all", "\u5168\u90E8"], ["raw", "\u539F\u6587"], ["applied", "\u5DF2\u66FF\u6362"]], (value) => this.setState({ filter: value }))),
            !shown.length ? empty(records.length ? "\u5F53\u524D\u7B5B\u9009\u6CA1\u6709\u5185\u5BB9" : "\u8FD8\u6CA1\u6709\u5206\u6BB5\u6458\u8981", records.length ? "\u5207\u6362\u201C\u5168\u90E8\u201D\u67E5\u770B\u5176\u4ED6\u8BB0\u5F55\u3002" : "\u8FBE\u5230\u9884\u5904\u7406\u9891\u7387\u540E\uFF0C\u8FD9\u91CC\u4F1A\u81EA\u52A8\u51FA\u73B0\u57FA\u7840\u6458\u8981\u548C\u6587\u6863\u3002") : h("div", { className: "cx-list" }, ...shown.map((r, i) => h(
              "article",
              { className: "cx-card cx-record " + (selected.includes(r.id) ? "cx-selected" : ""), key: r.id },
              h("div", { className: "cx-row" }, h("label", { className: "cx-record-check" }, h("input", { type: "checkbox", checked: selected.includes(r.id), disabled: !r.live || locked, onChange: (e) => this.select(r.id, e.target.checked), "aria-label": "\u9009\u62E9 " + r.id }), h("span", { className: "cx-record-number" }, String(i + 1).padStart(2, "0")), h("time", null, date(r.timeStart) + " \u2014 " + time(r.timeEnd))), badge(r.live ? r.kind === "full" ? "\u5168\u91CF\u6458\u8981" : names2[r.mode] || r.mode : "\u5386\u53F2\u5B58\u6863", r.mode === "raw" ? "" : "blue")),
              summaryPreview(r.summary),
              h("div", { className: "cx-record-footer" }, h("small", { title: r.id }, h("code", null, r.id.slice(0, 8)), " \xB7 ", rangeLabel(r.ranges)), button(`${r.documentCount || 0} \u6587\u6863 \xB7 ${r.assetCount || 0} \u9644\u4EF6`, () => this.document(r.id), { icon: "context", quiet: true }))
            ))),
            fold("\u4E2D\u67A2\u6700\u8FD1\u7684\u9009\u62E9", d.review?.choices?.length ? `${d.review.choices.length} \u9879\u51B3\u5B9A` : "\u8FD8\u6CA1\u6709\u5B8C\u6210\u7684\u5224\u65AD", h(
              "div",
              null,
              ...(d.review?.choices || []).map((c, i) => h("div", { className: "cx-decision", key: i }, badge(names2[c.action] || c.action, "blue"), h("code", null, c.ids?.map((id) => id.slice(0, 8)).join("\u3001")), c.reason && h("p", null, c.reason))),
              d.review?.lastDiscard && h("p", { className: "cx-hint" }, "\u8D44\u6599\u66F4\u65B0\u540E\uFF0C\u8FC7\u671F\u51B3\u5B9A\u5DF2\u4F5C\u5E9F\uFF1B\u4E0D\u8BA1\u4E3A\u6A21\u578B\u5931\u8D25\uFF0C\u4E5F\u4E0D\u89E6\u53D1\u5F3A\u5236\u91CD\u8BD5\u3002"),
              button("\u67E5\u770B\u4E2D\u67A2\u5B8C\u6574\u8F93\u5165", this.readReview, { quiet: true, icon: "context" }),
              this.state.review && h("pre", null, JSON.stringify(this.state.review.input, null, 2))
            )),
            d.todoRefresh && h("p", { className: "cx-hint" }, "\u4E0A\u6B21\u538B\u7F29\u540E\u5DF2\u6CE8\u5165\u6700\u65B0\u7248 todo\uFF0C\u5E76\u6E05\u7406\u65E7\u5FEB\u7167\uFF1B\u9884\u5904\u7406\u4E0D\u8BFB\u53D6 todo\u3002\u7528\u6237\u539F\u8BDD\u4E0E\u56FE\u7247\u3001\u6587\u6863\u540C\u5C5E\u8BE6\u7EC6\u8D44\u6599\u3002"),
            fold("Trace \u4E0E\u66FF\u6362\u8BB0\u5F55", d.trace ? "\u5DF2\u524D\u7F6E\u63D0\u4F9B\u65B9\u66B4\u9732\u7684\u63A8\u7406\u6587\u672C" : "\u5C1A\u65E0\u524D\u7F6E\u63A8\u7406", h(
              "div",
              null,
              h("p", { className: "cx-hint" }, d.trace ? "\u6765\u6E90\u4E8B\u4EF6 #" + d.trace.sourceSeq + (d.trace.truncated ? " \xB7 \u6309\u8BBE\u7F6E\u622A\u53D6" : " \xB7 \u539F\u6587\u672C") : "\u6CA1\u6709\u5DF2\u524D\u7F6E\u7684\u63A8\u7406\u6587\u672C\uFF1B\u4E0D\u4F1A\u751F\u6210\u66FF\u4EE3\u63A8\u7406\u3002"),
              d.lastReplacement && h("pre", null, JSON.stringify(d.lastReplacement, null, 2)),
  ...
  class SummaryPanel extends PollPanel {
    ...
    render() {
      ...
      return h(
        "div",
        { className: "cx-panel" },
        heading(privateSession ? "\u4F1A\u8BDD\u6458\u8981" : "\u9879\u76EE\u6458\u8981", privateSession ? "\u672C\u4F1A\u8BDD\u79C1\u6709\u5386\u53F2\uFF0C\u4E0D\u53C2\u4E0E\u5171\u4EAB\u8BB0\u5FC6\u3002" : "\u6309\u4F1A\u8BDD\u6574\u7406\uFF0C\u6309\u539F\u59CB\u4E8B\u4EF6\u65F6\u95F4\u56DE\u770B\u3002", "memory", button(null, this.load, { quiet: true, icon: "refresh", label: "\u5237\u65B0\u6458\u8981" })),
        h(
          "div",
          { className: "cx-body" },
          alert(error, true),
          alert(notice),
          h("div", { className: "cx-catalog-banner" }, icon(privateSession ? "lock" : "layers", 19), h("div", null, h("strong", null, privateSession ? "\u4EC5\u5F53\u524D\u4F1A\u8BDD\u53EF\u89C1" : "\u9879\u76EE\u5171\u4EAB\u6863\u6848"), h("small", null, !d ? "\u6B63\u5728\u8BFB\u53D6\u2026" : `${groups.size} \u4E2A\u4F1A\u8BDD \xB7 ${entries.length} \u6BB5\u6458\u8981 \xB7 \u6587\u6863\u6309\u9700\u8BFB\u53D6`))),
          ...
          ...[...groups].map(([sid, list]) => h(
            "section",
            { className: "cx-session", key: sid },
            h("header", { className: "cx-session-head" }, h("span", { className: "cx-session-icon" }, icon("context", 15)), h("div", null, h("h3", null, list[0].sessionTitle || sid), h("small", { title: sid }, sid.length > 28 ? sid.slice(0, 28) + "\u2026" : sid)), badge(list.length + " \u6BB5")),
            h("div", { className: "cx-timeline" }, ...list.map((r) => h("article", { className: "cx-timeline-record", key: r.id }, h("span", { className: "cx-timeline-dot" }), h("time", null, date(r.timeStart), " \u2014 ", time(r.timeEnd)), summaryPreview(r.summary), h("div", { className: "cx-record-footer" }, h("code", { title: r.id }, r.id.slice(0, 8)), button(`\u8BFB\u53D6 ${r.documentCount || 0} \u6587\u6863 \xB7 ${r.assetCount || 0} \u9644\u4EF6`, () => this.document(r.id), { quiet: true, icon: "context" })))))
          )),
          d && !entries.length && empty("\u6CA1\u6709\u5339\u914D\u7684\u6458\u8981", search ? "\u8BD5\u8BD5\u5176\u4ED6\u5173\u952E\u8BCD\uFF0C\u6216\u6E05\u7A7A\u7B5B\u9009\u3002" : privateSession ? "\u672C\u4F1A\u8BDD\u5B8C\u6210\u9884\u5904\u7406\u540E\uFF0C\u6458\u8981\u4F1A\u663E\u793A\u5728\u8FD9\u91CC\u3002" : "\u9879\u76EE\u7EA7\u4F1A\u8BDD\u5B8C\u6210\u9884\u5904\u7406\u540E\uFF0C\u6458\u8981\u4F1A\u6309\u4F1A\u8BDD\u5F52\u6863\u3002"),
          !privateSession && d && fold("\u65E7\u81EA\u52A8\u8BB0\u5FC6", "\u53EA\u8BFB\u4FDD\u7559\uFF0C\u4E0D\u81EA\u52A8\u91CD\u65B0\u6CE8\u5165", h("div", null, button("\u8BFB\u53D6\u672C\u9879\u76EE\u65E7\u6761\u76EE", async () => {
            const sid = this.props.sessionId;
            try {
              const r = await api3("/memories" + suffix2(sid));
              if (this.alive && sid === this.props.sessionId) this.setState({ legacy: r.items });
            } catch (e) {
              if (this.alive && sid === this.props.sessionId) this.setState({ error: e.message });
            }
          }, { icon: "memory", quiet: true }), this.state.legacy && h("pre", null, JSON.stringify(this.state.legacy, null, 2))))
        ),
        this.reader()
      );
    }
  ...
  class ContextSettings2 extends React21.Component {
    ...
    loadSettings = async () => {
      try {
        const s = await api3("/state");
        if (this.alive) {
          this.saved = s.config;
          this.setState({ config: { ...s.config }, directory: s.directory || [], routing: contextRouteMode(s.config), error: "" });
        }
      } catch (e) {
        if (this.alive) this.setState({ error: e.message });
      }
    };
    loadGlobal = async () => {
      try {
        const g = await api3("/context/global");
        if (this.alive) this.setState({ globalText: g.text, globalSaved: g.text, globalRevision: g.revision, globalLoaded: true, globalError: "" });
      } catch (e) {
        if (this.alive) this.setState({ globalError: e.message });
      }
    };
    ...
    save = async (e) => {
      e?.preventDefault();
      if (this.state.busy || !this.state.config) return;
      const patch = contextSettingsPatch(this.saved, this.state.config);
      if (!Object.keys(patch).length) return;
      this.setState({ busy: true, error: "", status: "" });
      try {
        const next = await api3("/settings", patch);
        if (this.alive) {
          this.saved = next;
          this.setState({ config: { ...next }, routing: contextRouteMode(next), custom: false, status: "\u8BBE\u7F6E\u5DF2\u4FDD\u5B58" });
        }
      } catch (e2) {
        if (this.alive) this.setState({ error: e2.message });
      } finally {
    ...
    saveGlobal = async () => {
      ...
      try {
        const g = await api3("/context/global", { text: this.state.globalText, revision: this.state.globalRevision });
        if (this.alive) this.setState({ globalText: g.text, globalSaved: g.text, globalRevision: g.revision, globalStatus: "\u5168\u5C40\u80CC\u666F\u5DF2\u4FDD\u5B58" });
      } catch (e) {
        if (this.alive) this.setState({ globalError: e.message });
      } finally {
        if (this.alive) this.setState({ busy: false });
    ...
    route(key, label) {
      ...
      const efforts = [.../* @__PURE__ */ new Set(["off", "low", "medium", "high", "max", r.effort || "off"])];
      return h("div", { className: "cx-route" }, h("div", { className: "cx-route-label" }, icon("layers", 14), label), h(
        "div",
        { className: "cx-grid" },
        ...
        field("Temperature", h("input", { type: "number", min: 0, max: 2, step: 0.1, value: r.temperature ?? "", placeholder: "\u63D0\u4F9B\u65B9\u9ED8\u8BA4", onChange: (e) => update("temperature", e.target.value === "" ? void 0 : Number(e.target.value)), "aria-label": label + "Temperature" }))
      ), h("datalist", { id: listId }, ...models.map((m) => h("option", { key: m.id, value: m.id }))));
    }
    frequency() {
      ...
      return section("\u5904\u7406\u9891\u7387", "\u4FDD\u7559\u539F\u6709\u56DB\u6863\u64CD\u4F5C\uFF0C\u53C2\u6570\u5BF9\u5E94\u65B0\u7684\u5904\u7406\u94FE\u8DEF\u3002", h(
        React21.Fragment,
        null,
        segments2("\u66F4\u65B0\u9891\u7387", value, Object.entries(frequencyNames), this.pickPreset),
        ...
        h("p", { className: "cx-hint cx-frequency-caption" }, desc, " \u5206\u6BB5\u7A97\u53E3 ", String(c.digestWindow), " \u6761\uFF1B\u4E2D\u67A2\u6700\u77ED\u95F4\u9694 ", duration2(c.coordinatorMinGapMs), "\u3002"),
        value === "custom" && h("div", { className: "cx-custom-fields" }, h("div", { className: "cx-grid" }, this.number("digestEvery", "\u9884\u5904\u7406\u9891\u7387 \xB7 \u65B0\u4E8B\u4EF6\u6570", 1), this.number("digestWindow", "\u76EE\u6807\u5206\u6BB5\u7A97\u53E3 \xB7 \u4E8B\u4EF6\u6570", 1), this.number("coordinatorEvery", "\u4E2D\u67A2\u9891\u7387 \xB7 \u65B0\u6458\u8981\u6570", 1), this.number("coordinatorMinGapMs", "\u4E2D\u67A2\u6700\u77ED\u95F4\u9694 \xB7 \u79D2", 0, void 0, 1e3), this.number("surgeryCooldownSteps", "\u81EA\u52A8\u66FF\u6362\u6700\u77ED\u6B65\u6570", 0))),
        h("p", { className: "cx-footnote" }, "\u6863\u4F4D\u4E0D\u4F1A\u4FEE\u6539\u6A21\u578B\u3001\u4F1A\u8BDD\u8303\u56F4\u3001Trace \u6216\u7A7A\u95F2\u51B2\u5237\u3002\u5DF2\u6709\u8BBE\u7F6E\u4E0D\u4F1A\u5728\u6253\u5F00\u9875\u9762\u65F6\u88AB\u91CD\u7F6E\u3002")
    ...
    renderBasic() {
      ...
      return h(
        ...
        section("\u7A7A\u95F2\u9884\u5904\u7406", "\u9ED8\u8BA4\u5173\u95ED\uFF1B\u4E0D\u5F71\u54CD\u6309\u65B0\u4E8B\u4EF6\u6570\u91CF\u89E6\u53D1\u7684\u6B63\u5E38\u9884\u5904\u7406\uFF0C\u4E5F\u4E0D\u5F71\u54CD\u624B\u52A8\u64CD\u4F5C\u3002", h(
          React21.Fragment,
          null,
          this.toggle("idlePreprocessEnabled", "\u7A7A\u95F2\u65F6\u81EA\u52A8\u9884\u5904\u7406", "\u4EC5\u5728\u4F1A\u8BDD\u771F\u6B63\u7A7A\u95F2\u4E14\u6709\u5F85\u5904\u7406\u5185\u5BB9\u65F6\u89E6\u53D1\uFF1B\u6A21\u578B\u6216\u5DE5\u5177\u8FD0\u884C\u4E2D\u4E0D\u8BA1\u65F6\u3002"),
          this.number("flushIdleMs", "\u7A7A\u95F2\u7B49\u5F85\u65F6\u95F4 \xB7 \u79D2", 0, "\u9ED8\u8BA4 90 \u79D2\uFF1B\u5173\u95ED\u5F00\u5173\u4F1A\u53D6\u6D88\u7B49\u5F85\u4E2D\u7684\u4EFB\u52A1\u3002\u5DF2\u5F00\u59CB\u7684\u4EFB\u52A1\u6B63\u5E38\u7ED3\u675F\uFF0C0 \u79D2\u4E5F\u8868\u793A\u7981\u7528\u3002", 1e3, !c.idlePreprocessEnabled)
        )),
    ...
    renderAdvanced() {
      ...
      return h(
        React21.Fragment,
        null,
        h("div", { className: "cx-info" }, icon("info"), h("p", null, "\u9891\u7387\u6863\u4F4D\u53EF\u4EE5\u76F4\u63A5\u4F7F\u7528\u3002\u9700\u8981\u7CBE\u8C03\u65F6\u518D\u5C55\u5F00\uFF1B\u8FD9\u4E9B\u9009\u9879\u5747\u5BF9\u5E94\u4ECD\u5728\u8FD0\u884C\u7684\u529F\u80FD\u3002")),
        fold("\u9884\u5904\u7406\u7A97\u53E3", "\u5206\u6BB5\u4E0E\u53C2\u8003\u524D\u6587\uFF1B\u7A7A\u95F2\u5F00\u5173\u89C1\u57FA\u7840\u8BBE\u7F6E", h("div", { className: "cx-grid" }, this.number("digestEvery", "\u9884\u5904\u7406\u9891\u7387 \xB7 \u65B0\u4E8B\u4EF6\u6570", 1), this.number("digestWindow", "\u76EE\u6807\u5206\u6BB5\u7A97\u53E3 \xB7 \u4E8B\u4EF6\u6570", 1, "\u4FDD\u7559\u5B8C\u6574\u5DE5\u5177\u5F80\u8FD4\uFF0C\u5B9E\u9645\u6BB5\u957F\u53EF\u80FD\u8D85\u8FC7\u7A97\u53E3\u3002"), this.number("digestLookback", "\u53C2\u8003\u524D\u6587 \xB7 \u4E8B\u4EF6\u6570", 0))),
        fold("\u6574\u7A97\u9884\u7B97\u4E0E\u540E\u53F0\u989D\u5EA6", "\u4E00\u6B21\u89E6\u53D1\u53EF\u4EE5\u5904\u7406\u591A\u7A97\uFF1B\u5269\u4F59\u79EF\u538B\u5355\u72EC\u8BB0\u5F55\uFF0C\u4E0D\u65E0\u9650\u8865\u5386\u53F2\u3002", h("div", { className: "cx-grid" }, this.number("prepareBatchWindows", "\u6BCF\u6B21\u89E6\u53D1\u6700\u591A\u5904\u7406\u7A97\u53E3\u6570", 1), this.number("prepareContinueTokens", "\u7EED\u8DD1\u6700\u4F4E\u6587\u672C\u91CF \xB7 \u4F30\u7B97 tokens", 1, "\u540E\u7EED\u7A97\u53E3\u9700\u88C5\u6EE1\u65B0\u7684\u5B9E\u9645\u6D88\u606F\uFF0C\u6216\u8FBE\u5230\u8BE5\u6587\u672C\u91CF\uFF1B\u96F6\u788E\u5C3E\u5DF4\u7559\u5230\u4E0B\u6B21\uFF0C\u4E0D\u542B\u53C2\u8003\u524D\u6587\u4E0E\u65E7\u6458\u8981\u3002"), this.number("prepareInputTokens", "\u5355\u7A97\u8F93\u5165\u9884\u7B97 \xB7 \u4F30\u7B97 tokens", 1), this.number("summaryTargetChars", "\u57FA\u7840\u6458\u8981\u76EE\u6807 \xB7 \u5B57\u7B26", 1, "\u8D85\u8FC7\u76EE\u6807\u4E24\u500D\u65F6\u91CD\u8BD5\uFF0C\u4E0D\u76F4\u63A5\u622A\u65AD\u539F\u6587\u3002"), this.number("backgroundConcurrency", "\u540E\u53F0\u6700\u5927\u5E76\u53D1\u8C03\u7528", 1), this.number("backgroundMaxRetries", "\u81EA\u52A8\u91CD\u8BD5\u6B21\u6570", 0))),
        fold("\u4E2D\u67A2\u4E0E\u8BF7\u6C42\u66FF\u6362", "\u5224\u65AD\u9891\u7387\u3001\u8FD1\u671F\u539F\u6587\u548C\u81EA\u52A8\u5E94\u7528\u95F4\u9694", h(React21.Fragment, null, h("div", { className: "cx-grid" }, this.number("coordinatorEvery", "\u4E2D\u67A2\u9891\u7387 \xB7 \u65B0\u6458\u8981\u6570", 1), this.number("coordinatorMinGapMs", "\u4E2D\u67A2\u6700\u77ED\u95F4\u9694 \xB7 \u79D2", 0, void 0, 1e3), this.number("coordinatorRecentEvents", "\u4E2D\u67A2\u8FD1\u671F\u539F\u6587\u7A97\u53E3", 0), this.number("surgeryCooldownSteps", "\u81EA\u52A8\u66FF\u6362\u6700\u77ED\u6B65\u6570", 0), this.number("keepTailEvents", "\u6682\u7559\u8FD1\u671F\u4E8B\u4EF6\u6570", 0)), this.toggle("requireShorter", "\u66FF\u6362\u540E\u7684\u603B\u91CF\u5E94\u66F4\u5C0F", "\u5C06\u6458\u8981\u3001\u8BE6\u7EC6\u8D44\u6599\u548C\u524D\u7F6E Trace \u4E00\u8D77\u8BA1\u7B97\u3002"))),
        fold("Trace \u4E0E\u8D44\u6E90\u4E0A\u9650", "0 \u4F7F\u7528\u539F\u6709\u9ED8\u8BA4\u8BED\u4E49\uFF0C\u4E0D\u81EA\u52A8\u88C1\u5207\u5185\u5BB9", h("div", { className: "cx-grid" }, this.number("traceMaxChars", "\u63A8\u7406\u6587\u672C\u5B57\u7B26\u4E0A\u9650", 0, "0 \u4FDD\u7559\u6240\u9009\u63A8\u7406\u5168\u6587\uFF1B\u6B63\u6570\u4FDD\u7559\u5C3E\u90E8\u5E76\u6807\u6CE8\u622A\u53D6\u3002"), this.number("digestMaxTokens", "\u9884\u5904\u7406\u8F93\u51FA Token \u4E0A\u9650", 0, "0 \u4F7F\u7528\u63D0\u4F9B\u65B9\u9ED8\u8BA4\u3002"), this.number("surgeonMaxTokens", "\u4E2D\u67A2\u8F93\u51FA Token \u4E0A\u9650", 0), this.number("jobTimeoutMs", "\u540E\u53F0\u8D85\u65F6 \xB7 \u79D2", 0, "\u9ED8\u8BA4 600 \u79D2\uFF0810 \u5206\u949F\uFF09\uFF1B0 \u4E0D\u8BBE\u7F6E\u63D2\u4EF6\u8D85\u65F6\u3002", 1e3))),
        fold("\u7535\u8111\u64CD\u63A7", "\u6CBF\u7528\u539F\u6709\u6D4F\u89C8\u5668\u4E0E\u684C\u9762\u8FDE\u63A5\u8BBE\u7F6E", h(React21.Fragment, null, this.toggle("computerUseEnabled", "\u542F\u7528\u7535\u8111\u64CD\u63A7", "\u4EFB\u52A1\u548C\u7535\u8111\u9762\u677F\u4ECD\u4F7F\u7528\u539F\u6709\u529F\u80FD\u3002"), ...[["computerUseBrowserExecutable", "\u6D4F\u89C8\u5668\u7A0B\u5E8F\u8DEF\u5F84"], ["computerUseChromeUserDataDir", "\u6D4F\u89C8\u5668\u7528\u6237\u6570\u636E\u76EE\u5F55"], ["computerUseNativeBinary", "\u684C\u9762\u63A7\u5236\u7A0B\u5E8F\u8DEF\u5F84"], ["computerUseNativeSocket", "\u684C\u9762\u8FDE\u63A5 Socket"]].map(([key, label]) => field(label, h("input", { value: c[key] || "", placeholder: "\u81EA\u52A8\u68C0\u6D4B / \u539F\u6709\u9ED8\u8BA4", onChange: (e) => this.set(key, e.target.value) }))))),
    ...
    renderModels() {
      ...
      return h(
        React21.Fragment,
        null,
        section("\u540E\u53F0\u6A21\u578B", "\u4E3B\u6267\u884C\u6A21\u578B\u4ECD\u5728 DSH \u7684\u6A21\u578B\u8BBE\u7F6E\u4E2D\u9009\u62E9\u3002", h(
          React21.Fragment,
          null,
          segments2("\u540E\u53F0\u6A21\u578B\u914D\u7F6E\u65B9\u5F0F", mode, [["follow", "\u8DDF\u968F\u4E3B\u6A21\u578B"], ["unified", "\u7EDF\u4E00\u914D\u7F6E"], ["separate", "\u5206\u522B\u914D\u7F6E"]], this.chooseRoute),
          mode === "follow" ? h("div", { className: "cx-info" }, icon("layers"), h("p", null, "\u9884\u5904\u7406 AI \u548C\u4E2D\u67A2\u4F7F\u7528\u5F53\u524D\u4F1A\u8BDD\u7684\u63D0\u4F9B\u65B9\u4E0E\u6A21\u578B\u3002")) : mode === "unified" ? this.route("unifiedBackground", "\u9884\u5904\u7406\u4E0E\u4E2D\u67A2") : h(React21.Fragment, null, this.route("background", "\u9884\u5904\u7406 AI"), this.route("surgeon", "\u4E2D\u67A2 AI"))
        )),
    ...
    renderGlobal() {
      return h(
        React21.Fragment,
        null,
        alert(this.state.globalError, true),
        h("div", { className: "cx-catalog-banner" }, icon("globe", 20), h("div", null, h("strong", null, "\u53EA\u7531\u4F60\u7EF4\u62A4\u7684\u5168\u5C40\u80CC\u666F"), h("small", null, "\u9879\u76EE\u4F1A\u8BDD\u53EF\u8BFB\u53D6\uFF1B\u79C1\u6709\u4F1A\u8BDD\u4E0D\u8BFB\u53D6\u3002"))),
        section("\u56FA\u5B9A\u80CC\u666F", "\u540E\u53F0 AI \u4E0D\u81EA\u52A8\u65B0\u589E\u3001\u8865\u5145\u6216\u6539\u5199\u8FD9\u6BB5\u5185\u5BB9\u3002", field("\u5168\u5C40\u56FA\u5B9A\u80CC\u666F", h("textarea", { className: "cx-global-editor", rows: 14, value: this.state.globalText, disabled: !this.state.globalLoaded, onChange: (e) => this.setState({ globalText: e.target.value, globalStatus: "" }), placeholder: "\u5199\u4E0B\u9002\u7528\u4E8E\u9879\u76EE\u4F1A\u8BDD\u7684\u56FA\u5B9A\u80CC\u666F\uFF0C\u4F8B\u5982\u5DE5\u4F5C\u4E60\u60EF\u3001\u73AF\u5883\u7EA6\u5B9A\u3002" })), badge(fmt2(this.state.globalText.length) + " \u5B57\u7B26")),
    ...
    render() {
      ...
      return h(
        "div",
        { className: "cx-panel cx-settings", "data-context-ui": CONTEXT_UI_VERSION },
        heading("\u504F\u597D\u8BBE\u7F6E", "\u6A21\u578B\u3001\u4E0A\u4E0B\u6587\u4E0E\u9879\u76EE\u6458\u8981", "settings"),
        pageTabs(page, [["basic", "\u5E38\u7528"], ["models", "\u6A21\u578B\u4E0E\u8EAB\u4EFD"], ["advanced", "\u9AD8\u7EA7"], ["global", "\u5168\u5C40\u80CC\u666F"]], (value) => this.setState({ page: value })),
        !c ? h("div", { className: "cx-body" }, alert(error, true), empty("\u6B63\u5728\u8BFB\u53D6\u8BBE\u7F6E", "\u4FDD\u7559\u5DF2\u4FDD\u5B58\u7684\u53C2\u6570\uFF0C\u4E0D\u81EA\u52A8\u5957\u7528\u4EFB\u4F55\u6863\u4F4D\u3002"), error && button("\u91CD\u8BD5", this.loadSettings, { icon: "refresh" })) : h(
          "form",
          { className: "cx-settings-form", onSubmit: isGlobal ? (e) => {
            e.preventDefault();
            this.saveGlobal();
          } : this.save },
          ...
          h("footer", { className: "cx-savebar" }, h("span", { className: "cx-save-status", role: "status" }, icon(status || this.state.globalStatus ? "check" : "info", 13), footStatus), h(
            "div",
  ...
  class ScopeControl extends React21.Component {
    ...
    componentDidUpdate(prev) {
      if (prev.sessionId !== this.props.sessionId || prev.locked !== this.props.locked) {
        if (prev.sessionId !== this.props.sessionId) this.setState({ data: null, error: "" });
        this.load();
      }
    }
    componentWillUnmount() {
    ...
    load = async () => {
      const id = this.props.sessionId;
      try {
        const data = await api3("/scope" + suffix2(id));
        if (this.alive && id === this.props.sessionId) this.setState({ data, error: "" });
      } catch (e) {
        if (this.alive && id === this.props.sessionId) this.setState({ error: e.message });
      }
    };
    render() {
      ...
      return h(
        "label",
        { className: "cx-scope-chip", title: this.state.error || (d?.locked || this.props.locked ? "\u672C\u4F1A\u8BDD\u5DF2\u7ED1\u5B9A\u8303\u56F4" : "\u65B0\u4F1A\u8BDD\u7684\u6458\u8981\u5171\u4EAB\u8303\u56F4") },
        icon(d?.scope === "project" ? "layers" : "lock", 13),
        h("select", { "aria-label": "\u4F1A\u8BDD\u8303\u56F4", disabled: !d || d.locked || this.props.locked || this.state.busy, value: d?.scope || "session", onChange: async (e) => {
          const id = this.props.sessionId, scope = e.target.value;
          this.setState({ busy: true });
          try {
            const data = await api3("/scope" + suffix2(id), { scope });
            if (this.alive && id === this.props.sessionId) this.setState({ data, error: "" });
          } catch (e2) {
            if (this.alive && id === this.props.sessionId) this.setState({ error: e2.message });
            await this.load();
          } finally {
            if (this.alive) this.setState({ busy: false });
          }
        } }, h("option", { value: "session" }, "\u4F1A\u8BDD\u9694\u79BB"), h("option", { value: "project" }, "\u9879\u76EE\u5171\u4EAB"))
      );
    }
  }
  const ScopeChip2 = (props) => {
    const current = props.useSessions((s) => s.byId[props.sessionId]);
    return h(ScopeControl, { ...props, locked: current?.blank === false });
  };
  const PipelineSlot = (props) => {
    const { tab } = props.useTabInfo();
    return h(PipelinePanel, { ...props, visible: tab.visible });
  };
  const SummarySlot = (props) => {
    const { tab } = props.useTabInfo();
    return h(SummaryPanel, { ...props, visible: tab.visible });
  };
  const tabs = [["tasks", "\u4EFB\u52A1", "task"], ["context", "\u4E0A\u4E0B\u6587", "context"], ["memory", "\u6458\u8981", "memory"], ["computer", "\u7535\u8111", "computer"], ["monitor", "\u76D1\u63A7", "monitor"]];
  const wrapWorkbench2 = (Original, initial = "tasks") => function ContextWorkbench(props) {
    const info = props.useTabInfo(), section2 = info.tab.navigation?.params?.section || initial;
    const active = tabs.some(([key]) => key === section2) ? section2 : "tasks";
    return h(
      "div",
      { className: "cx-integrated" },
      h("nav", { className: "cx-navigation", "aria-label": "\u5DE5\u4F5C\u53F0\u5BFC\u822A" }, ...tabs.map(([key, text, name]) => h("button", { key, type: "button", "aria-current": active === key ? "page" : void 0, onClick: () => info.tab.actions.openTab("trisoul-x-workbench", { params: { section: key }, replaceTab: info.tab.kind !== "trisoul-x-workbench" }) }, icon(name, 15), h("span", null, text)))),
      h("div", { hidden: active !== "context" }, h(PipelineSlot, { ...props, useTabInfo: () => {
        const v = props.useTabInfo();
        return { ...v, tab: { ...v.tab, visible: v.tab.visible && active === "context" } };
      } })),
      h("div", { hidden: active !== "memory" }, h(SummarySlot, { ...props, useTabInfo: () => {
        const v = props.useTabInfo();
        return { ...v, tab: { ...v.tab, visible: v.tab.visible && active === "memory" } };
      } })),
      h("div", { className: "cx-legacy", hidden: ["context", "memory"].includes(active) }, h(Original, { ...props, useTabInfo: () => {
        const v = props.useTabInfo();
        return { ...v, tab: { ...v.tab, visible: v.tab.visible && !["context", "memory"].includes(active), navigation: { ...v.tab.navigation, params: { ...v.tab.navigation?.params, section: ["context", "memory"].includes(active) ? "tasks" : active } } } };
      } }))
    );
  };
  return { ContextSettings: ContextSettings2, ScopeChip: ScopeChip2, wrapWorkbench: wrapWorkbench2, applyStyle(ctx) {
    ctx.effect(() => {
      const style = document.createElement("style");
      style.dataset.plugin = "trisoul-context-v1";
      style.dataset.version = CONTEXT_UI_VERSION;
...
// src/client/index.jsx
var { ContextSettings, ScopeChip, wrapWorkbench, applyStyle } = createContextUI(import_react20.default);
...
var kindName = { compactFull: "\u5168\u91CF\u538B\u7F29", prepare: "\u4E0A\u4E0B\u6587\u9884\u5904\u7406", coordinate: "\u66FF\u6362\u4E2D\u67A2", main: "\u4E3B\u6267\u884C", subagent: "\u5B50\u4EE3\u7406", background: "\u8BB0\u5FC6\u6D88\u5316", recall: "\u8BB0\u5FC6\u68C0\u7D22", state: "\u72B6\u6001\u63D0\u70BC", curation: "\u8BB0\u5FC6\u6574\u7406", surgeon: "\u4E0A\u4E0B\u6587\u6574\u7406", probeAsk: "\u63A2\u9488\u51FA\u9898", probeAnswer: "\u63A2\u9488\u4F5C\u7B54" };
function BetterTodoChip({ sessionId, useSessions }) {
  const [state, setState] = (0, import_react20.useState)(null), [open, setOpen] = (0, import_react20.useState)(false), [saving, setSaving] = (0, import_react20.useState)(false), [error, setError] = (0, import_react20.useState)("");
  const [notice, setNotice] = (0, import_react20.useState)(false), dialog = (0, import_react20.useRef)(null), noticeId = (0, import_react20.useId)();
  const current = useSessions((s) => s.byId[sessionId]), active = (0, import_react20.useRef)(sessionId), revision = (0, import_react20.useRef)(0), writing = (0, import_react20.useRef)(null);
  ...
  const chip = /* @__PURE__ */ import_react20.default.createElement("button", { type: "button", className: cx("tx-scope-chip", "tx-bt-chip", ready && !state.todo && !state.verification && "tx-bt-off"), "aria-label": "BT \xB7 Better Todo", "aria-haspopup": "menu", "aria-expanded": open, title: "Better Todo \xB7 \u6536\u5C3E\u63D0\u9192", onClick: () => {
    void load();
    setOpen(!open);
  } }, /* @__PURE__ */ import_react20.default.createElement("strong", null, "BT"), /* @__PURE__ */ import_react20.default.createElement("span", null, "\u25BE"));
  const items = [{ type: "label", id: "title", text: "Better Todo" }, ...[
    ["todo", "\u5F85\u529E\u5B8C\u6210\u63D0\u9192", "\u4ECD\u6709\u672A\u5B8C\u6210\u5F85\u529E\u65F6\u63D0\u9192\u7EE7\u7EED"],
    ["verification", "\u9A8C\u8BC1\u5B8C\u6210\u63D0\u9192", "\u7F3A\u5C11\u9A8C\u8BC1\u8BC1\u636E\u65F6\u63D0\u9192\uFF0C\u542B\u6587\u5B57\u8BC1\u636E\u590D\u6838"]
  ].map(([id, label, hint]) => ({ id, disabled: !ready || saving, label: /* @__PURE__ */ import_react20.default.createElement("span", { className: "tx-bt-option" }, /* @__PURE__ */ import_react20.default.createElement("span", null, /* @__PURE__ */ import_react20.default.createElement("strong", null, label), /* @__PURE__ */ import_react20.default.createElement("small", null, hint)), /* @__PURE__ */ import_react20.default.createElement("span", { className: "tx-bt-state" }, /* @__PURE__ */ import_react20.default.createElement("small", null, ready ? state[id] ? "\u5F00" : "\u5173" : "\u2026"), /* @__PURE__ */ import_react20.default.createElement("i", { className: cx("tx-bt-toggle", ready && state[id] && "tx-on"), "aria-hidden": "true" }))) }))];
  return /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, null, /* @__PURE__ */ import_react20.default.createElement(import_dsh_client_ui_primitives2.Menu, { open, anchor: chip, items, footer: [{ type: "label", id: "status", text: error || "\u4EC5\u672C\u4F1A\u8BDD \xB7 \u53EF\u968F\u65F6\u66F4\u6539" }], onSelect: toggle, onClose: () => setOpen(false), portal: true, side: "top", align: "end", compact: true, autoFocus: true }), /* @__PURE__ */ import_react20.default.createElement("dialog", { ref: dialog, className: "tx-bt-notice", "aria-labelledby": noticeId, "aria-describedby": noticeId + "-body", onCancel: () => setNotice(false), onClose: () => setNotice(false) }, /* @__PURE__ */ import_react20.default.createElement("h2", { id: noticeId }, "\u9A8C\u8BC1\u5B8C\u6210\u63D0\u9192"), /* @__PURE__ */ import_react20.default.createElement("p", { id: noticeId + "-body" }, "\u6B64\u9009\u9879\u5C06\u4F1A\u5E26\u6765\u66F4\u9AD8\u7684\u4EFB\u52A1\u5B8C\u6210\u7387\uFF0C\u540C\u65F6\u4E5F\u4F1A\u6D88\u8017\u66F4\u591A\u65F6\u95F4\u548C token\u3002"), /* @__PURE__ */ import_react20.default.createElement("div", null, /* @__PURE__ */ import_react20.default.createElement("button", { type: "button", autoFocus: true, onClick: () => setNotice(false) }, "\u77E5\u9053\u4E86"))));
}
function useSnapshot(id, visible = true, range = "session") {
  const [data, setData] = (0, import_react20.useState)(null), [error, setError] = (0, import_react20.useState)("");
  const key = `${id}:${range}`, current = (0, import_react20.useRef)(key);
  current.current = key;
...
function Icon2({ name, size = 16 }) {
  ...
  return /* @__PURE__ */ import_react20.default.createElement("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true" }, /* @__PURE__ */ import_react20.default.createElement("path", { d: paths[name] || paths.context }));
}
function Action({ children, icon, primary, quiet, className, ...props }) {
  return /* @__PURE__ */ import_react20.default.createElement("button", { type: "button", className: cx("tx-button", primary && "tx-primary", quiet && "tx-quiet", !children && "tx-icon-button", className), ...props }, icon && /* @__PURE__ */ import_react20.default.createElement(Icon2, { name: icon }), " ", children);
}
function Tabs({ value, onChange, items, label }) {
  return /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-tabs", role: "tablist", "aria-label": label }, items.map(([id, title, count]) => /* @__PURE__ */ import_react20.default.createElement("button", { type: "button", role: "tab", "aria-selected": value === id, key: id, onClick: () => onChange(id) }, title, count != null && /* @__PURE__ */ import_react20.default.createElement("span", null, count))));
}
function Segments({ value, onChange, items, label }) {
  return /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-segments", role: "group", "aria-label": label }, items.map(([id, title]) => /* @__PURE__ */ import_react20.default.createElement("button", { key: id, type: "button", "aria-pressed": value === id, onClick: () => onChange(id) }, title)));
}
function Header({ icon, title, subtitle, actions }) {
  return /* @__PURE__ */ import_react20.default.createElement("header", { className: "tx-page-head" }, /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-title-line" }, /* @__PURE__ */ import_react20.default.createElement("span", { className: "tx-page-icon" }, /* @__PURE__ */ import_react20.default.createElement(Icon2, { name: icon, size: 20 })), /* @__PURE__ */ import_react20.default.createElement("div", null, /* @__PURE__ */ import_react20.default.createElement("h2", null, title), subtitle && /* @__PURE__ */ import_react20.default.createElement("p", null, subtitle))), actions && /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-head-actions" }, actions));
}
function Empty({ icon = "layers", title, children }) {
  return /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-empty" }, /* @__PURE__ */ import_react20.default.createElement("span", null, /* @__PURE__ */ import_react20.default.createElement(Icon2, { name: icon, size: 24 })), /* @__PURE__ */ import_react20.default.createElement("h3", null, title), children && /* @__PURE__ */ import_react20.default.createElement("p", null, children));
}
function Badge({ children, tone }) {
  return /* @__PURE__ */ import_react20.default.createElement("span", { className: cx("tx-badge", tone && "tx-" + tone) }, children);
}
function Alert({ children, error }) {
  return children ? /* @__PURE__ */ import_react20.default.createElement("div", { className: cx("tx-alert", error && "tx-alert-error"), role: error ? "alert" : "status" }, children) : null;
}
function Fold({ title, subtitle, children, count, open = false }) {
  return /* @__PURE__ */ import_react20.default.createElement("details", { className: "tx-fold", open: open || void 0 }, /* @__PURE__ */ import_react20.default.createElement("summary", null, /* @__PURE__ */ import_react20.default.createElement("div", null, /* @__PURE__ */ import_react20.default.createElement("strong", null, title), subtitle && /* @__PURE__ */ import_react20.default.createElement("small", null, subtitle)), count != null && /* @__PURE__ */ import_react20.default.createElement(Badge, null, count), /* @__PURE__ */ import_react20.default.createElement(Icon2, { name: "chevron" })), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-fold-body" }, children));
}
function Evidence({ link }) {
  ...
  return /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-evidence" }, /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-row-between" }, /* @__PURE__ */ import_react20.default.createElement("strong", null, link.path || (link.kind === "test" ? "\u6D4B\u8BD5\u9A8C\u8BC1" : "\u6587\u5B57\u8BB0\u5F55")), /* @__PURE__ */ import_react20.default.createElement(Badge, { tone: link.lastRun?.pass ? "good" : link.lastRun ? "warn" : void 0 }, verdict)), link.cmd && /* @__PURE__ */ import_react20.default.createElement("pre", null, link.cmd), link.note && /* @__PURE__ */ import_react20.default.createElement("p", { className: "tx-prose" }, link.note), link.reason && /* @__PURE__ */ import_react20.default.createElement("p", { className: "tx-help" }, "\u539F\u56E0\uFF1A", link.reason), link.lastRun?.tail && /* @__PURE__ */ import_react20.default.createElement("details", { className: "tx-subfold" }, /* @__PURE__ */ import_react20.default.createElement("summary", null, "\u67E5\u770B\u8FD0\u884C\u8F93\u51FA"), /* @__PURE__ */ import_react20.default.createElement("pre", null, link.lastRun.tail)));
}
function ContextPanel({ sessionId, useTabInfo }) {
  const { tab } = useTabInfo(), { data, error, reload } = useSnapshot(sessionId, tab.visible);
  const [page, setPage] = (0, import_react20.useState)("tasks"), [status, setStatus] = (0, import_react20.useState)(""), [compacting, setCompacting] = (0, import_react20.useState)(false), [failed, setFailed] = (0, import_react20.useState)(false);
  ...
  return /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-app" }, /* @__PURE__ */ import_react20.default.createElement(Header, { icon: "context", title: "\u5DE5\u4F5C\u4E0A\u4E0B\u6587", subtitle: "\u4EFB\u52A1\u4E0E\u9A8C\u6536\uFF1B\u65E7\u72B6\u6001\u53CA\u65E7\u8BB0\u5FC6\u4EC5\u4F5C\u5386\u53F2\u67E5\u9605", actions: /* @__PURE__ */ import_react20.default.createElement(Action, { quiet: true, icon: compacting ? "clock" : "layers", disabled: data?.running !== "idle" || compacting, onClick: compact }, compacting ? "\u6574\u7406\u4E2D" : "\u6574\u7406") }), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-context-summary" }, /* @__PURE__ */ import_react20.default.createElement("div", null, /* @__PURE__ */ import_react20.default.createElement("span", { className: "tx-status-dot" }), /* @__PURE__ */ import_react20.default.createElement("span", null, data?.running !== "idle" && data?.running ? "\u6B63\u5728\u6267\u884C" : tasks.length && done === tasks.length ? "\u4EFB\u52A1\u5DF2\u5B8C\u6210" : tasks.length ? "\u4EFB\u52A1\u5F85\u7EE7\u7EED" : "\u7B49\u5F85\u65B0\u4EFB\u52A1")), tasks.length > 0 && /* @__PURE__ */ import_react20.default.createElement("span", null, /* @__PURE__ */ import_react20.default.createElement("strong", null, done), " / ", tasks.length, " \u5B8C\u6210")), tasks.length > 0 && /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-progress", role: "progressbar", "aria-label": "\u4EFB\u52A1\u5B8C\u6210\u8FDB\u5EA6", "aria-valuenow": done, "aria-valuemin": 0, "aria-valuemax": tasks.length }, /* @__PURE__ */ import_react20.default.createElement("i", { style: { width: `${done / tasks.length * 100}%` } })), /* @__PURE__ */ import_react20.default.createElement(Tabs, { label: "\u4E0A\u4E0B\u6587\u5206\u7C7B", value: page, onChange: setPage, items: [["tasks", "\u4EFB\u52A1", tasks.length || void 0], ["state", "\u5DE5\u4F5C\u72B6\u6001"], ["memory", "\u8BB0\u5FC6\u6587\u6863"]] }), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-body" }, /* @__PURE__ */ import_react20.default.createElement(Alert, { error: true }, error), /* @__PURE__ */ import_react20.default.createElement(Alert, { error: failed }, status), page === "tasks" && /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, null, tasks.length ? /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-task-list" }, tasks.map((task, i) => /* @__PURE__ */ import_react20.default.createElement("article", { className: "tx-task", key: task.id || i }, /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-task-title" }, /* @__PURE__ */ import_react20.default.createElement("span", { className: cx("tx-task-check", task.status === "completed" && "is-done") }, task.status === "completed" ? /* @__PURE__ */ import_react20.default.createElement(Icon2, { name: "check", size: 13 }) : /* @__PURE__ */ import_react20.default.createElement("span", null)), /* @__PURE__ */ import_react20.default.createElement("strong", null, task.content), /* @__PURE__ */ import_react20.default.createElement("span", { className: "tx-task-id" }, task.id)), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-task-badges" }, /* @__PURE__ */ import_react20.default.createElement(Badge, { tone: task.status === "completed" ? "good" : void 0 }, task.status === "completed" ? "\u5DF2\u5B8C\u6210" : "\u5F85\u5B8C\u6210"), task.links?.some((l) => l.lastRun?.pass) ? /* @__PURE__ */ import_react20.default.createElement(Badge, { tone: "good" }, "\u6D4B\u8BD5\u901A\u8FC7") : /* @__PURE__ */ import_react20.default.createElement(Badge, null, task.links?.length ? "\u5DF2\u6709\u8BC1\u636E" : "\u5F85\u9A8C\u8BC1")), /* @__PURE__ */ import_react20.default.createElement("details", { className: "tx-task-detail" }, /* @__PURE__ */ import_react20.default.createElement("summary", null, "\u9700\u6C42\u539F\u6587\u4E0E\u9A8C\u8BC1 ", /* @__PURE__ */ import_react20.default.createElement(Icon2, { name: "chevron", size: 13 })), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-quote" }, task.source || "\u5C1A\u672A\u7ED1\u5B9A\u539F\u6587\u951A\u70B9", task.anchor && /* @__PURE__ */ import_react20.default.createElement("small", null, "\u6D88\u606F ", task.sourceMessage, " \xB7 \u6458\u5F55 ", task.sourceExcerpt)), task.links?.length ? task.links.map((link) => /* @__PURE__ */ import_react20.default.createElement(Evidence, { key: link.id, link })) : /* @__PURE__ */ import_react20.default.createElement("p", { className: "tx-help" }, "\u5B8C\u6210\u4EFB\u52A1\u540E\uFF0C\u5173\u8054\u5B9E\u9645\u9A8C\u8BC1\u8BC1\u636E\u3002"), task.verification && /* @__PURE__ */ import_react20.default.createElement("p", { className: "tx-prose" }, task.verification.method, /* @__PURE__ */ import_react20.default.createElement("br", null), task.verification.result))))) : /* @__PURE__ */ import_react20.default.createElement(Empty, { icon: "check", title: "\u4EFB\u52A1\u4F1A\u5728\u8FD9\u91CC\u5C55\u5F00" }, "\u591A\u6B65\u9AA4\u5DE5\u4F5C\u5F00\u59CB\u540E\uFF0C\u53EF\u4EE5\u67E5\u770B\u9700\u6C42\u3001\u8FDB\u5C55\u4E0E\u9A8C\u8BC1\u7ED3\u679C\u3002"), data?.taskRelease?.total > 0 && /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-footnote" }, "\u6700\u8FD1\u6536\u5C3E \xB7 ", data.taskRelease.done, "/", data.taskRelease.total, " \u5B8C\u6210 \xB7 \u6D4B\u8BD5\u578B ", data.taskRelease.tested, " \xB7 \u6587\u5B57\u578B ", data.taskRelease.textOnly)), page === "state" && /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, null, /* @__PURE__ */ import_react20.default.createElement("section", { className: "tx-section" }, /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-section-heading" }, /* @__PURE__ */ import_react20.default.createElement("h3", null, "\u5F53\u524D\u72B6\u6001"), /* @__PURE__ */ import_react20.default.createElement(Badge, null, fmt(context?.digestCount), " \u4E2A\u5DF2\u6D88\u5316\u533A\u95F4")), context?.status ? /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-prose tx-state-text" }, context.status) : /* @__PURE__ */ import_react20.default.createElement(Empty, { icon: "context", title: "\u72B6\u6001\u5C1A\u672A\u5F62\u6210" }, "\u5BF9\u8BDD\u63A8\u8FDB\u540E\uFF0C\u8FD9\u91CC\u4F1A\u66F4\u65B0\u8BA1\u5212\u3001\u8FDB\u5EA6\u548C\u7ED3\u8BBA\u3002"), context?.stateFailures > 0 && /* @__PURE__ */ import_react20.default.createElement(Alert, { error: true }, "\u72B6\u6001\u63D0\u70BC\u8FDE\u7EED\u5931\u8D25 ", context.stateFailures, " \u6B21\u3002")), /* @__PURE__ */ import_react20.default.createElement("section", { className: "tx-section" }, /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-section-heading" }, /* @__PURE__ */ import_react20.default.createElement("h3", null, "\u7EA6\u675F\u4E0E\u51B3\u5B9A"), /* @__PURE__ */ import_react20.default.createElement(Badge, null, context?.pins?.length || 0)), context?.pins?.length ? context.pins.map((pin, i) => /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-pin", key: i }, /* @__PURE__ */ import_react20.default.createElement(Icon2, { name: "pin" }), /* @__PURE__ */ import_react20.default.createElement("span", null, pin))) : /* @__PURE__ */ import_react20.default.createElement("p", { className: "tx-help" }, "\u7528\u6237\u786E\u5B9A\u7684\u7EA6\u675F\u548C\u51B3\u5B9A\u4F1A\u4FDD\u7559\u5728\u8FD9\u91CC\u3002")), context?.notes?.length > 0 && /* @__PURE__ */ import_react20.default.createElement(Fold, { title: "\u5DE5\u4F5C\u7B14\u8BB0", count: context.notes.length }, context.notes.map((note, i) => /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-note-line", key: i }, /* @__PURE__ */ import_react20.default.createElement("p", { className: "tx-prose" }, note.text), /* @__PURE__ */ import_react20.default.createElement("small", null, shortDate(note.at)))))), page === "memory" && /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, null, /* @__PURE__ */ import_react20.default.createElement("section", { className: "tx-section" }, /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-section-heading" }, /* @__PURE__ */ import_react20.default.createElement("h3", null, "\u4EFB\u52A1\u8BB0\u5FC6\u6587\u6863"), context?.workdocVersion > 0 && /* @__PURE__ */ import_react20.default.createElement(Badge, null, "v", context.workdocVersion)), context?.workdoc ? /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-prose tx-document" }, context.workdoc) : /* @__PURE__ */ import_react20.default.createElement(Empty, { icon: "memory", title: "\u8FD8\u6CA1\u6709\u4EFB\u52A1\u8BB0\u5FC6" }, "\u627E\u5230\u4E0E\u5F53\u524D\u5DE5\u4F5C\u76F8\u5173\u7684\u8BB0\u5FC6\u540E\uFF0C\u4F1A\u5728\u8FD9\u91CC\u6C47\u96C6\u4E0E\u66F4\u65B0\u3002"), context?.supplementPending > 0 && /* @__PURE__ */ import_react20.default.createElement("p", { className: "tx-help" }, "\u53E6\u6709 ", context.supplementPending, " \u6761\u8BB0\u5FC6\u7B49\u5F85\u8865\u5165\u3002")), context?.checkpoint && /* @__PURE__ */ import_react20.default.createElement(Fold, { title: "\u8F83\u65E9\u5DE5\u4F5C\u7684\u7EAA\u8981", subtitle: shortDate(context.checkpoint.at) }, /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-prose tx-document" }, context.checkpoint.text)), context?.probe && /* @__PURE__ */ import_react20.default.createElement(Fold, { title: "\u6700\u8FD1\u538B\u7F29\u68C0\u67E5", subtitle: context.probe.error ? "\u8C03\u7528\u5931\u8D25" : context.probe.ok ? "\u4E8B\u5B9E\u68C0\u67E5\u901A\u8FC7" : "\u53D1\u73B0\u9057\u6F0F\uFF0C\u5DF2\u8BB0\u5F55\u8865\u8BB0" }, /* @__PURE__ */ import_react20.default.createElement("p", null, context.probe.question), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-detail-grid" }, /* @__PURE__ */ import_react20.default.createElement("span", null, "\u53C2\u8003\u7B54\u6848"), /* @__PURE__ */ import_react20.default.createElement("strong", null, context.probe.expected || "\u2014"), /* @__PURE__ */ import_react20.default.createElement("span", null, "\u5B9E\u9645\u56DE\u7B54"), /* @__PURE__ */ import_react20.default.createElement("strong", null, context.probe.got || "\u2014")), /* @__PURE__ */ import_react20.default.createElement(Alert, { error: true }, context.probe.error)), context?.probeNotes?.length > 0 && /* @__PURE__ */ import_react20.default.createElement(Fold, { title: "\u5F85\u5199\u5165\u7EAA\u8981\u7684\u8865\u8BB0", count: context.probeNotes.length }, context.probeNotes.map((line, i) => /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-note-line", key: i }, line))))));
}
...
function FrameBar({ nodes = [] }) {
  return /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-frame-bar" }, nodes.map((n) => /* @__PURE__ */ import_react20.default.createElement("i", { key: n.seq, style: { flex: n.tokens || 0, background: frameColor(n.kind) }, title: `#${n.seq} ${frameKind(n.kind)} \xB7 \u7EA6 ${fmt(n.tokens)} tokens` })));
}
function FrameLegend() {
  return /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-legend" }, ["checkpoint", "state", "memory", "tasks", "model", "user", "tool", "system"].map((kind) => /* @__PURE__ */ import_react20.default.createElement("span", { key: kind }, /* @__PURE__ */ import_react20.default.createElement("i", { style: { background: frameColor(kind) } }), frameKind(kind))));
}
function ContextHistory({ data }) {
  const frames = data.contextHistory || [], [selected, setSelected] = (0, import_react20.useState)(null);
  const selectedFrame = frames.find((f) => f.at === selected) || frames.at(-1), rows = contextHistoryLayout(frames);
  if (!frames.length) return /* @__PURE__ */ import_react20.default.createElement(Empty, { icon: "layers", title: "\u7B49\u5F85\u4E0B\u4E00\u6B21\u8BF7\u6C42" }, "\u8BF7\u6C42\u53D1\u51FA\u540E\uFF0C\u53EF\u4EE5\u5728\u8FD9\u91CC\u67E5\u770B\u4E0A\u4E0B\u6587\u4E0E\u7F13\u5B58\u7684\u53D8\u5316\u3002");
  return /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-context-history" }, /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-section-heading" }, /* @__PURE__ */ import_react20.default.createElement("h3", null, "\u4E0A\u4E0B\u6587\u6F14\u53D8"), /* @__PURE__ */ import_react20.default.createElement("span", { className: "tx-muted" }, "\u6700\u8FD1 ", frames.length, " \u6B21\u8BF7\u6C42")), /* @__PURE__ */ import_react20.default.createElement("p", { className: "tx-help" }, "\u8272\u5757\u6309\u8BB0\u5F55\u4F30\u7B97\uFF0C\u6240\u6709\u884C\u5171\u7528\u523B\u5EA6\u3002\u4E0B\u65B9\u7EC6\u8F68\u4E3A\u5B9E\u9645\u8F93\u5165\uFF0C\u84DD\u8272\u90E8\u5206\u4E3A\u7F13\u5B58\u8BFB\u53D6\u91CF\u3002"), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-history-chart" }, rows.map(({ frame, tokens, width, inputWidth, cacheWidth }, i) => /* @__PURE__ */ import_react20.default.createElement("button", { key: frame.at + ":" + i, type: "button", className: cx("tx-history-row", selectedFrame === frame && "tx-selected"), onClick: () => setSelected(frame.at), title: `\u7B2C ${frame.turn} \u56DE\u5408 \xB7 \u7B2C ${frame.step} \u6B65 \xB7 \u8BB0\u5F55\u4F30\u7B97 ${fmt(tokens)} tokens` }, /* @__PURE__ */ import_react20.default.createElement("span", null, frame.turn, ".", frame.step), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-history-scale" }, /* @__PURE__ */ import_react20.default.createElement("div", { style: { width: `${width}%` } }, /* @__PURE__ */ import_react20.default.createElement(FrameBar, { nodes: frame.nodes })), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-history-usage" }, /* @__PURE__ */ import_react20.default.createElement("i", { style: { width: `${inputWidth}%` } }), /* @__PURE__ */ import_react20.default.createElement("b", { style: { width: `${cacheWidth}%` } }))), /* @__PURE__ */ import_react20.default.createElement("span", null, "\u2248", compactNumber(tokens))))), /* @__PURE__ */ import_react20.default.createElement(FrameLegend, null), selectedFrame && /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-selected-frame" }, /* @__PURE__ */ import_react20.default.createElement(Badge, null, "\u7B2C ", selectedFrame.turn, " \u56DE\u5408 \xB7 \u7B2C ", selectedFrame.step, " \u6B65"), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-detail-grid" }, /* @__PURE__ */ import_react20.default.createElement("span", null, "\u8BB0\u5F55\u4F30\u7B97 Token"), /* @__PURE__ */ import_react20.default.createElement("strong", null, "\u2248", fmt(frameTokens(selectedFrame.nodes))), /* @__PURE__ */ import_react20.default.createElement("span", null, "\u5B9E\u9645\u8F93\u5165 Token"), /* @__PURE__ */ import_react20.default.createElement("strong", null, selectedFrame.inputTokens === void 0 ? "\u672A\u8BB0\u5F55" : fmt(selectedFrame.inputTokens)), /* @__PURE__ */ import_react20.default.createElement("span", null, "\u7F13\u5B58\u8BFB\u53D6 Token"), /* @__PURE__ */ import_react20.default.createElement("strong", null, fmt(selectedFrame.cacheReadTokens)))));
}
function Timeline({ calls, onSelect }) {
  const ordered = calls.slice().reverse();
  if (!ordered.length) return /* @__PURE__ */ import_react20.default.createElement(Empty, { icon: "monitor", title: "\u7B49\u5F85\u7B2C\u4E00\u6B21\u6267\u884C" }, "\u5F00\u59CB\u5BF9\u8BDD\u540E\uFF0C\u5404\u7EC4\u4EF6\u7684\u8C03\u7528\u4F1A\u51FA\u73B0\u5728\u8FD9\u91CC\u3002");
  return /* @__PURE__ */ import_react20.default.createElement("section", { className: "tx-section" }, /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-section-heading" }, /* @__PURE__ */ import_react20.default.createElement("h3", null, "\u8C03\u7528\u8F68\u8FF9"), /* @__PURE__ */ import_react20.default.createElement("span", { className: "tx-muted" }, "\u4ECE\u5DE6\u5230\u53F3 \xB7 \u70B9\u51FB\u67E5\u770B")), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-timeline" }, Object.entries(kindName).filter(([kind]) => ordered.some((c) => c.kind === kind)).map(([kind, label]) => /* @__PURE__ */ import_react20.default.createElement("div", { key: kind, className: "tx-timeline-row" }, /* @__PURE__ */ import_react20.default.createElement("span", null, label), /* @__PURE__ */ import_react20.default.createElement("div", null, ordered.map((call, i) => call.kind === kind ? /* @__PURE__ */ import_react20.default.createElement("button", { key: i, type: "button", className: call.error ? "tx-call-error" : "tx-call", onClick: () => onSelect(call), "aria-label": `${label} \xB7 ${shortDate(call.at)} \xB7 ${duration(call.durationMs)}`, title: `${label} \xB7 ${call.turn ?? "\u2014"}.${call.step ?? "\u2014"} \xB7 ${duration(call.durationMs)}${call.error ? " \xB7 " + call.error : ""}` }) : /* @__PURE__ */ import_react20.default.createElement("i", { key: i })))))), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-legend" }, /* @__PURE__ */ import_react20.default.createElement("span", null, /* @__PURE__ */ import_react20.default.createElement("i", { style: { background: "var(--tx-blue)" } }), "\u5B8C\u6210\u8C03\u7528"), /* @__PURE__ */ import_react20.default.createElement("span", null, /* @__PURE__ */ import_react20.default.createElement("i", { style: { background: "var(--tx-danger)" } }), "\u8C03\u7528\u5931\u8D25")));
}
function Monitor({ sessionId, useTabInfo }) {
  const { tab } = useTabInfo(), [range, setRange] = (0, import_react20.useState)("session"), [page, setPage] = (0, import_react20.useState)("overview"), [stage, setStage] = (0, import_react20.useState)("all"), [failures, setFailures] = (0, import_react20.useState)(false), [selected, setSelected] = (0, import_react20.useState)(null);
  ...
  return /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-app" }, /* @__PURE__ */ import_react20.default.createElement(Header, { icon: "monitor", title: "\u6267\u884C\u76D1\u63A7", subtitle: "\u770B\u6E05\u6BCF\u6B21\u8C03\u7528\u4E0E\u4E0A\u4E0B\u6587\u53D8\u5316" }), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-monitor-top" }, /* @__PURE__ */ import_react20.default.createElement(Segments, { label: "\u76D1\u63A7\u7EDF\u8BA1\u8303\u56F4", value: range, onChange: setRange, items: [["session", "\u5F53\u524D\u4F1A\u8BDD"], ["all", "\u5168\u90E8\u4F1A\u8BDD"]] }), /* @__PURE__ */ import_react20.default.createElement("div", { className: cx("tx-running-label", (running || live.length > 0) && "is-running") }, /* @__PURE__ */ import_react20.default.createElement("span", { className: "tx-status-dot" }), running ? "\u6267\u884C\u4E2D" : live.length ? "\u540E\u53F0\u8FD0\u884C\u4E2D" : "\u7A7A\u95F2")), /* @__PURE__ */ import_react20.default.createElement(Tabs, { label: "\u76D1\u63A7\u5206\u7C7B", value: page, onChange: setPage, items: [["overview", "\u6982\u89C8"], ["calls", "\u8C03\u7528\u8BB0\u5F55"], ["context", "\u4E0A\u4E0B\u6587"]] }), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-body" }, /* @__PURE__ */ import_react20.default.createElement(Alert, { error: true }, error), page === "overview" && /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, null, /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-stats-grid" }, [["\u603B\u7528\u91CF", compactNumber(totals.input + totals.output), "tokens"], ["\u7F13\u5B58\u547D\u4E2D", totals.input ? (totals.cache / totals.input * 100).toFixed(1) + "%" : "\u2014", "\u8F93\u5165\u7F13\u5B58"], ["\u6A21\u578B\u8C03\u7528", fmt(totals.calls), `${totals.errors} \u6B21\u5931\u8D25`], ["\u7D2F\u8BA1\u7528\u65F6", duration(totals.ms), "\u5404\u7EC4\u4EF6\u5408\u8BA1"]].map(([label, value, hint]) => /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-stat", key: label }, /* @__PURE__ */ import_react20.default.createElement("span", null, label), /* @__PURE__ */ import_react20.default.createElement("strong", null, value), /* @__PURE__ */ import_react20.default.createElement("small", null, hint)))), live.length > 0 && /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-live-list" }, live.map((call, i) => /* @__PURE__ */ import_react20.default.createElement("div", { key: i }, /* @__PURE__ */ import_react20.default.createElement("span", { className: "tx-pulse" }), /* @__PURE__ */ import_react20.default.createElement("div", null, /* @__PURE__ */ import_react20.default.createElement("strong", null, kindName[call.kind] || call.kind), /* @__PURE__ */ import_react20.default.createElement("small", null, call.model)), /* @__PURE__ */ import_react20.default.createElement("span", null, duration(Date.now() - call.startedAt))))), /* @__PURE__ */ import_react20.default.createElement(Timeline, { calls: data?.activity || [], onSelect: choose }), Object.keys(metrics).length > 0 && /* @__PURE__ */ import_react20.default.createElement("section", { className: "tx-section" }, /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-section-heading" }, /* @__PURE__ */ import_react20.default.createElement("h3", null, "\u7EC4\u4EF6\u7528\u91CF"), /* @__PURE__ */ import_react20.default.createElement("span", { className: "tx-muted" }, "\u8C03\u7528 / Token")), Object.entries(kindName).filter(([kind]) => metrics[kind]?.calls).map(([kind, label]) => {
    const m = metrics[kind], last = data?.activity?.find((a) => a.kind === kind), total = inputTokens(m) + (m.outputTokens || 0);
    return /* @__PURE__ */ import_react20.default.createElement("details", { className: "tx-component", key: kind }, /* @__PURE__ */ import_react20.default.createElement("summary", null, /* @__PURE__ */ import_react20.default.createElement("span", null, /* @__PURE__ */ import_react20.default.createElement("i", { className: cx("tx-component-dot", m.errors > 0 && "has-error") }), label), /* @__PURE__ */ import_react20.default.createElement("span", null, /* @__PURE__ */ import_react20.default.createElement("strong", null, fmt(m.calls)), /* @__PURE__ */ import_react20.default.createElement("small", null, compactNumber(total), " tok"), /* @__PURE__ */ import_react20.default.createElement(Icon2, { name: "chevron", size: 13 }))), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-component-details" }, /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-detail-grid" }, /* @__PURE__ */ import_react20.default.createElement("span", null, "\u8F93\u5165 / \u8F93\u51FA"), /* @__PURE__ */ import_react20.default.createElement("strong", null, fmt(inputTokens(m)), " / ", fmt(m.outputTokens)), /* @__PURE__ */ import_react20.default.createElement("span", null, "\u7F13\u5B58\u547D\u4E2D"), /* @__PURE__ */ import_react20.default.createElement("strong", null, inputTokens(m) ? ((m.cacheReadTokens || 0) / inputTokens(m) * 100).toFixed(1) + "%" : "\u2014"), /* @__PURE__ */ import_react20.default.createElement("span", null, "\u63A8\u7406 Token"), /* @__PURE__ */ import_react20.default.createElement("strong", null, m.reasoningTokens == null ? "\u2014" : fmt(m.reasoningTokens)), /* @__PURE__ */ import_react20.default.createElement("span", null, "\u5CF0\u503C\u8F93\u5165 / \u7D2F\u8BA1\u7528\u65F6"), /* @__PURE__ */ import_react20.default.createElement("strong", null, compactNumber(m.peakContext), " / ", duration(m.durationMs)), /* @__PURE__ */ import_react20.default.createElement("span", null, "\u5931\u8D25"), /* @__PURE__ */ import_react20.default.createElement("strong", null, fmt(m.errors))), last && /* @__PURE__ */ import_react20.default.createElement("p", { className: "tx-help tx-path" }, last.provider, " / ", last.model), m.unmetered > 0 && /* @__PURE__ */ import_react20.default.createElement("p", { className: "tx-help" }, m.unmetered, " \u6B21\u8C03\u7528\u672A\u8FD4\u56DE\u7528\u91CF")));
  })), /* @__PURE__ */ import_react20.default.createElement(Fold, { title: "\u8BB0\u5FC6\u4E0E\u538B\u7F29\u7EDF\u8BA1", subtitle: "\u540E\u53F0\u6D41\u7A0B\u7684\u7D2F\u8BA1\u6267\u884C\u7ED3\u679C" }, /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-detail-grid" }, [["\u8BB0\u5FC6\u6D88\u5316 / \u5931\u8D25", `${fmt(actions.digests)} / ${fmt(actions.digestErrors)}`], ["\u8BB0\u5FC6\u6574\u7406 / \u5931\u8D25", `${fmt(actions.curations)} / ${fmt(actions.curationErrors)}`], ["\u6CE8\u5165 / \u6587\u6863\u66F4\u65B0", `${fmt(actions.injections)} / ${fmt(actions.workdocVersions)}`], ["\u72B6\u6001\u63D0\u70BC / \u5931\u8D25", `${fmt(actions.states)} / ${fmt(actions.stateErrors)}`], ["\u53EC\u56DE / \u547D\u4E2D\u6761\u6570", `${fmt(actions.recalls)} / ${fmt(actions.recallHits)}`], ["\u68C0\u7D22\u56DE\u9000", fmt(actions.retrievalFallbacks)], ["\u538B\u7F29 / \u5931\u8D25", `${fmt(actions.surgeries)} / ${fmt(actions.surgeryErrors)}`], ["\u66FF\u6362 / \u51B3\u7B56 / \u6587\u6863\u56DE\u67E5", `${fmt(actions.contextReplacements)} / ${fmt(actions.contextDecisions)} / ${fmt(actions.documentRecalls)}`], ["\u68C0\u67E5\u8C03\u7528\u5931\u8D25", fmt(actions.probeErrors)], ["\u539F\u6587\u56DE\u635E / \u65E7\u5FEB\u7167\u6E05\u7406", `${fmt(actions.rawRecalls)} / ${fmt(actions.staleVersions)}`], ["\u538B\u7F29\u540E\u5B57\u7B26\u5360\u6BD4", actions.compactInputChars ? (actions.compactOutputChars / actions.compactInputChars * 100).toFixed(1) + "%" : "\u2014"]].map(([label, value]) => /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, { key: label }, /* @__PURE__ */ import_react20.default.createElement("span", null, label), /* @__PURE__ */ import_react20.default.createElement("strong", null, value)))))), page === "calls" && /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, null, /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-call-filters" }, /* @__PURE__ */ import_react20.default.createElement("label", { className: "tx-field" }, /* @__PURE__ */ import_react20.default.createElement("select", { "aria-label": "\u8C03\u7528\u7EC4\u4EF6", value: stage, onChange: (e) => setStage(e.target.value) }, /* @__PURE__ */ import_react20.default.createElement("option", { value: "all" }, "\u5168\u90E8\u7EC4\u4EF6"), Object.entries(kindName).map(([id, label]) => /* @__PURE__ */ import_react20.default.createElement("option", { key: id, value: id }, label)))), /* @__PURE__ */ import_react20.default.createElement("label", { className: "tx-check" }, /* @__PURE__ */ import_react20.default.createElement("input", { type: "checkbox", checked: failures, onChange: (e) => setFailures(e.target.checked) }), "\u4EC5\u5931\u8D25")), activity.length ? activity.map((call) => /* @__PURE__ */ import_react20.default.createElement("details", { key: callId(call), className: cx("tx-call-row", call.error && "tx-failed-call"), open: selected === callId(call) || void 0 }, /* @__PURE__ */ import_react20.default.createElement("summary", null, /* @__PURE__ */ import_react20.default.createElement("span", { className: "tx-call-icon" }, /* @__PURE__ */ import_react20.default.createElement(Icon2, { name: call.error ? "close" : "check", size: 14 })), /* @__PURE__ */ import_react20.default.createElement("div", null, /* @__PURE__ */ import_react20.default.createElement("strong", null, kindName[call.kind] || call.kind), /* @__PURE__ */ import_react20.default.createElement("small", null, shortDate(call.at), call.step != null ? ` \xB7 \u7B2C ${call.step} \u6B65` : "")), /* @__PURE__ */ import_react20.default.createElement("span", null, duration(call.durationMs)), /* @__PURE__ */ import_react20.default.createElement(Icon2, { name: "chevron", size: 13 })), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-call-detail" }, /* @__PURE__ */ import_react20.default.createElement("p", { className: "tx-help tx-path" }, call.provider, " / ", call.model), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-detail-grid" }, /* @__PURE__ */ import_react20.default.createElement("span", null, "\u8F93\u5165 / \u8F93\u51FA"), /* @__PURE__ */ import_react20.default.createElement("strong", null, fmt(inputTokens(call.usage)), " / ", fmt(call.usage?.outputTokens)), /* @__PURE__ */ import_react20.default.createElement("span", null, "\u7F13\u5B58\u8BFB\u53D6"), /* @__PURE__ */ import_react20.default.createElement("strong", null, fmt(call.usage?.cacheReadTokens)), call.effort && /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, null, /* @__PURE__ */ import_react20.default.createElement("span", null, "\u63A8\u7406\u5F3A\u5EA6"), /* @__PURE__ */ import_react20.default.createElement("strong", null, call.effort))), /* @__PURE__ */ import_react20.default.createElement("p", { className: "tx-help tx-path" }, "\u4F1A\u8BDD ", call.sessionId), /* @__PURE__ */ import_react20.default.createElement(Alert, { error: true }, call.error)))) : /* @__PURE__ */ import_react20.default.createElement(Empty, { icon: "clock", title: "\u8FD9\u91CC\u8FD8\u6CA1\u6709\u8C03\u7528\u8BB0\u5F55" }, failures ? "\u5F53\u524D\u7B5B\u9009\u8303\u56F4\u5185\u6CA1\u6709\u5931\u8D25\u8C03\u7528\u3002" : "\u6A21\u578B\u8C03\u7528\u5B8C\u6210\u540E\uFF0C\u4F1A\u6309\u65F6\u95F4\u5217\u5728\u8FD9\u91CC\u3002"), /* @__PURE__ */ import_react20.default.createElement("p", { className: "tx-footnote" }, "\u5B8C\u6574\u6D88\u606F\u4E0E\u5DE5\u5177\u5F80\u8FD4\u53EF\u5728 DSH\u300C\u8F68\u8FF9\u300D\u4E2D\u67E5\u770B\u3002")), page === "context" && /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, null, data?.meter ? /* @__PURE__ */ import_react20.default.createElement("section", { className: "tx-section" }, /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-section-heading" }, /* @__PURE__ */ import_react20.default.createElement("h3", null, "\u5F53\u524D\u4F1A\u8BDD"), /* @__PURE__ */ import_react20.default.createElement(Badge, null, fmt(data.frame?.length), " \u6761\u8BB0\u5F55")), /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-context-number" }, compactNumber(data.meter.totalTokens), /* @__PURE__ */ import_react20.default.createElement("span", null, "tokens")), /* @__PURE__ */ import_react20.default.createElement(FrameBar, { nodes: (data.frame || []).map((n) => ({ ...n, kind: n.checkpoint ? "checkpoint" : n.kind })) }), /* @__PURE__ */ import_react20.default.createElement(FrameLegend, null), /* @__PURE__ */ import_react20.default.createElement("details", { className: "tx-subfold" }, /* @__PURE__ */ import_react20.default.createElement("summary", null, "\u67E5\u770B\u5404\u6761\u8BB0\u5F55"), data.frame?.map((n) => /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-frame-row", key: n.seq }, /* @__PURE__ */ import_react20.default.createElement("span", null, "#", n.seq, " \xB7 ", frameKind(n.checkpoint ? "checkpoint" : n.kind)), /* @__PURE__ */ import_react20.default.createElement("span", null, compactNumber(n.tokens), " tok"))))) : /* @__PURE__ */ import_react20.default.createElement(Empty, { icon: "layers", title: "\u5C1A\u65E0\u4E0A\u4E0B\u6587\u8BFB\u6570" }, "\u7EE7\u7EED\u4E00\u6B21\u5BF9\u8BDD\u540E\u5373\u53EF\u67E5\u770B\u3002"), data && /* @__PURE__ */ import_react20.default.createElement(ContextHistory, { data }))));
}
function StatsLine({ sessionId, onOpen }) {
  ...
  return /* @__PURE__ */ import_react20.default.createElement("button", { type: "button", className: "tx-stats-line", "aria-label": "\u67E5\u770B\u8FD0\u884C\u7EDF\u8BA1", title: `\u4E0A\u4E0B\u6587 ${fmt(data.meter?.totalTokens)} tokens \xB7 \u7F13\u5B58\u547D\u4E2D ${total ? Math.round((m.cacheReadTokens || 0) / total * 100) : 0}% \xB7 \u5DF2\u66FF\u6362 ${fmt(data.actions?.contextReplacements)} \u6B21`, onClick: onOpen }, /* @__PURE__ */ import_react20.default.createElement(Icon2, { name: "layers", size: 12 }), /* @__PURE__ */ import_react20.default.createElement("span", null, compactNumber(data.meter?.totalTokens), " \u4E0A\u4E0B\u6587"), data.liveCalls?.length > 0 && /* @__PURE__ */ import_react20.default.createElement("i", { className: "tx-stats-running", "aria-label": "\u540E\u53F0\u8FD0\u884C\u4E2D" }));
}
...
function apply(ctx) {
  ...
  function BaseWorkbench({ initialSection = "tasks", ...props }) {
    ...
    return /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-workbench" }, /* @__PURE__ */ import_react20.default.createElement("nav", { className: "tx-workbench-nav", "aria-label": "\u5DE5\u4F5C\u53F0\u5BFC\u822A" }, sections.map(([id, label, icon]) => /* @__PURE__ */ import_react20.default.createElement("button", { key: id, type: "button", "aria-current": section === id ? "page" : void 0, onClick: () => tab.actions.openTab("trisoul-x-workbench", { params: { section: id }, replaceTab: tab.kind !== "trisoul-x-workbench" }) }, icon === "computer" ? /* @__PURE__ */ import_react20.default.createElement(ComputerIcon, { size: 15 }) : /* @__PURE__ */ import_react20.default.createElement(Icon2, { name: icon, size: 15 }), /* @__PURE__ */ import_react20.default.createElement("span", null, label)))), sections.map(([id, , , Component]) => /* @__PURE__ */ import_react20.default.createElement("section", { key: id, className: "tx-workbench-page", hidden: section !== id, "aria-label": sections.find(([key]) => key === id)[1] }, /* @__PURE__ */ import_react20.default.createElement(Component, { ...props, useTabInfo: () => {
      const info = props.useTabInfo();
      return { ...info, tab: { ...info.tab, visible: info.tab.visible && section === id } };
    }, conversation: ctx.get("conversation") }))));
  }
  const workbenches = Object.fromEntries(["tasks", "memory", "computer", "monitor"].map((initial) => [initial, wrapWorkbench(BaseWorkbench, initial)]));
  function Workbench({ initialSection = "tasks", ...props }) {
    const Component = workbenches[initialSection] || workbenches.tasks;
    return /* @__PURE__ */ import_react20.default.createElement(Component, { ...props });
  }
  const { ComputerEntry } = applyComputerUseClient(ctx, { integrated: true, openPanel, renderPane: (props) => /* @__PURE__ */ import_react20.default.createElement(Workbench, { ...props, initialSection: "computer" }) });
  function ComposerDock(props) {
    const running = props.useSessions((s) => Boolean(s.byId[props.sessionId]?.running));
    const [usageOpen, setUsageOpen] = (0, import_react20.useState)(false);
    (0, import_react20.useEffect)(() => {
      setUsageOpen(false);
    }, [props.sessionId]);
    (0, import_react20.useEffect)(() => {
    ...
    return /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-composer-dock" }, /* @__PURE__ */ import_react20.default.createElement("div", { className: "tx-composer-tools" }, /* @__PURE__ */ import_react20.default.createElement("button", { type: "button", className: "tx-workbench-entry", "aria-label": "\u6253\u5F00\u5DE5\u4F5C\u53F0", onClick: () => openPanel("tasks") }, /* @__PURE__ */ import_react20.default.createElement(Icon2, { name: "context", size: 15 }), /* @__PURE__ */ import_react20.default.createElement("span", null, "\u5DE5\u4F5C\u53F0")), /* @__PURE__ */ import_react20.default.createElement(ComputerEntry, { ...props })), /* @__PURE__ */ import_react20.default.createElement("button", { type: "button", className: "tx-usage-toggle", "aria-label": "\u7528\u91CF\u8BE6\u60C5", "aria-expanded": usageOpen, onClick: () => setUsageOpen((value) => !value) }, /* @__PURE__ */ import_react20.default.createElement(Icon2, { name: "monitor", size: 14 }), /* @__PURE__ */ import_react20.default.createElement("span", null, "\u7528\u91CF"), /* @__PURE__ */ import_react20.default.createElement(Icon2, { name: "chevron", size: 12 })), /* @__PURE__ */ import_react20.default.createElement(StatsLine, { ...props, onOpen: () => openPanel("monitor") }));
  }
  ctx.effect(() => {
  ...
  for (const [seat, Component] of [["sidebar.brand.mark", BrandMark], ["sidebar.brand.name", BrandNameWithVersion], ["conversation.hero.brand.mark", () => /* @__PURE__ */ import_react20.default.createElement(BrandMark, { size: 64 })]]) ctx.slots.inject(seat, () => ctx.slots.register({ name: seat }, Component));
  ...
  ctx.effect(() => ctx.sidebarRightTabs.register({ id: workbenchId, kind: "trisoul-x-workbench", title: () => "\u5DE5\u4F5C\u53F0", guide: [{ order: 5, title: () => "\u5DE5\u4F5C\u53F0", description: () => "\u4EFB\u52A1\u3001\u8BB0\u5FC6\u3001\u7535\u8111\u4E0E\u8FD0\u884C\u76D1\u63A7", icon: (props) => /* @__PURE__ */ import_react20.default.createElement(Icon2, { name: "context", ...props }) }] }));
  ...
  for (const [kind, title, initialSection] of [
    ...
    ctx.slots.inject("sidebar.right.pane.tab", () => ctx.slots.register({ name: "sidebar.right.pane.tab", key: id }, (props) => /* @__PURE__ */ import_react20.default.createElement(Workbench, { ...props, initialSection })));
  }
  applyStyle(ctx);
}
