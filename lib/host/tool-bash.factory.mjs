      ...
      parameters: {
        ...
        ...escalationModes.length > 0 ? {
          sandbox_permissions: {
            ...
            description: (0, import_dsh_sandbox3.sandboxPermissionsDescription)("command")
          },
          justification: {
            type: "string",
